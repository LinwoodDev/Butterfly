...
@useResult
$Res call({
 int? index, Handler handler, CameraViewport cameraViewport, SettingsCubit settingsCubit, TransformCubit transformCubit, NetworkingService networkingService, bool isSaveDelayed, UtilitiesState utilities, Handler<Tool>? temporaryHandler, int? temporaryIndex, List<Renderer> foregrounds, Selection? selection, bool pinned, List<Renderer>? temporaryForegrounds, Map<int, Handler<Tool>> toggleableHandlers, List<Renderer> networkingForegrounds, Map<int, List<Renderer>> toggleableForegrounds, MouseCursor cursor, MouseCursor? temporaryCursor, TemporaryState temporaryState, Offset? lastPosition, List<int> pointers, int? buttons, AssetLocation location, Embedding? embedding, SaveState saved, PreferredSizeWidget? toolbar, PreferredSizeWidget? temporaryToolbar, Map<String, RendererState> rendererStates, Map<String, RendererState>? temporaryRendererStates, ViewOption viewOption, HideState hideUi, bool areaNavigatorCreate, bool areaNavigatorExact, bool areaNavigatorAsk, bool navigatorEnabled, NavigatorPage navigatorPage, bool isCreating, String userName, bool penDetected, bool sessionPenOnlyInput, bool wireframeMode
});
...
@override@JsonKey() final  bool wireframeMode;
