...
class _ButterflySettings extends ButterflySettings with DiagnosticableTreeMixin {
  const _ButterflySettings({this.theme = ThemeMode.system, this.density = ThemeDensity.system, this.localeTag = '', this.documentPath = '', this.gestureSensitivity = 1, this.touchSensitivity = 1, this.selectSensitivity = 1, this.scrollSensitivity = 1, this.penOnlyInput = false, this.inputGestures = true, this.design = '', this.bannerVisibility = BannerVisibility.always, @JsonKey(includeFromJson: false, includeToJson: false) final  List<AssetLocation> history = const [], this.zoomEnabled = true, this.lastVersion, @JsonKey(includeFromJson: false, includeToJson: false) final  List<ExternalStorage> connections = const [], this.defaultRemote = '', this.nativeTitleBar = false, this.startInFullScreen = false, this.navigationRail = true, this.ignorePressure = IgnorePressure.first, this.syncMode = SyncMode.noMobile, this.inputConfiguration = const InputConfiguration(), this.fallbackPack = '', final  List<String> starred = const [], this.defaultTemplate = '', this.navigatorPosition = NavigatorPosition.left, this.toolbarPosition = ToolbarPosition.inline, this.toolbarSize = ToolbarSize.normal, this.sortBy = SortBy.modified, this.sortOrder = SortOrder.descending, this.imageScale = 0.5, this.pdfQuality = 2, this.platformTheme = PlatformTheme.system, @SRGBConverter() final  List<SRGBColor> recentColors = const [], final  List<String> flags = const [], this.spreadPages = false, this.highContrast = false, this.gridView = false, this.autosave = true, this.showSaveButton = true, this.toolbarRows = 1, this.hideCursorWhileDrawing = false, this.utilities = const UtilitiesState(), this.onStartup = StartupBehavior.openHomeScreen, this.simpleToolbarVisibility = SimpleToolbarVisibility.show, this.optionsPanelPosition = OptionsPanelPosition.top, this.renderResolution = RenderResolution.normal, this.moveOnGesture = true, final  List<String> swamps = const []}): _history = history,_connections = connections,_starred = starred,_recentColors = recentColors,_flags = flags,_swamps = swamps,super._();
