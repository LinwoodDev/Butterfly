...
class ToolSelection extends StatelessWidget {
  ...
  ToolSelection({Key? key, this.isMobile = false, required this.viewportKey}) : super(key: key);
  ...
  Widget build(BuildContext context) {
    void bake() {
      ...
      if (size != null) {
        context
            .read<DocumentBloc>()
            .add(ImageBaked(size, MediaQuery.of(context).devicePixelRatio, transform.state));
      }
    }
              ...
              return Row(
                children: [
                  IconButton(
                      ...
                      onPressed: () {
                        var viewportSize =
                            viewportKey.currentContext?.size ?? MediaQuery.of(context).size;
                        context.read<TransformCubit>().zoom(1 / zoomConstant,
                  ...
                  IconButton(
                      ...
                      onPressed: () {
                        ...
                        var viewportSize =
                            viewportKey.currentContext?.size ?? MediaQuery.of(context).size;
                        cubit.size(1, Offset(viewportSize.width / 2, viewportSize.height / 2));
                        bake();
                      }),
                  IconButton(
                      ...
                      onPressed: () {
                        ...
                        context.read<TransformCubit>().zoom(
                            zoomConstant, Offset(viewportSize.width / 2, viewportSize.height / 2));
                        bake();
                      }),
                  ...
                  ConstrainedBox(
                    ...
                    child: TextField(
                      ...
                      onSubmitted: (value) {
                        ...
                        scale /= 100;
                        cubit.size(scale, Offset(viewportSize.width / 2, viewportSize.height / 2));
                      },
                      textAlign: TextAlign.center,
                      decoration: InputDecoration(
                          filled: true, labelText: AppLocalizations.of(context)!.zoom),
                    ),
                  ),
