...
Tool _$ToolFromJson(Map<String, dynamic> json) {
  switch (json['type']) {
    ...
    case 'polygon':
      return PolygonTool.fromJson(json);
...
class PolygonTool extends Tool {
  PolygonTool(
      ...
      : $type = $type ?? 'polygon',
        super._();
  factory PolygonTool.fromJson(Map<String, dynamic> json) =>
      _$PolygonToolFromJson(json);
  ...
  @JsonKey(includeFromJson: false, includeToJson: false)
  @pragma('vm:prefer-inline')
  $PolygonToolCopyWith<PolygonTool> get copyWith =>
      _$PolygonToolCopyWithImpl<PolygonTool>(this, _$identity);

  @override
  Map<String, dynamic> toJson() {
    return _$PolygonToolToJson(
      this,
    );
  }
...
abstract mixin class $PolygonToolCopyWith<$Res> implements $ToolCopyWith<$Res> {
  factory $PolygonToolCopyWith(
          PolygonTool value, $Res Function(PolygonTool) _then) =
      _$PolygonToolCopyWithImpl;
  @override
  @useResult
  $Res call(
      {String name,
...
/// @nodoc
class _$PolygonToolCopyWithImpl<$Res> implements $PolygonToolCopyWith<$Res> {
