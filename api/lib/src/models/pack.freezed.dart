...
@ColorJsonConverter() List<SRGBColor> get colors;
/// Create a copy of ColorPalette
/// with the given fields replaced by the non-null parameter values.
@JsonKey(includeFromJson: false, includeToJson: false)
@pragma('vm:prefer-inline')
$ColorPaletteCopyWith<ColorPalette> get copyWith => _$ColorPaletteCopyWithImpl<ColorPalette>(this as ColorPalette, _$identity);
...
/// @nodoc
abstract mixin class $ColorPaletteCopyWith<$Res> implements $PackAssetCopyWith<$Res> {
  factory $ColorPaletteCopyWith(ColorPalette value, $Res Function(ColorPalette) _then) = _$ColorPaletteCopyWithImpl;
@useResult
$Res call({
@ColorJsonConverter() List<SRGBColor> colors
});
...
/// @nodoc
class _$ColorPaletteCopyWithImpl<$Res>
...
@override@JsonKey()@ColorJsonConverter() List<SRGBColor> get colors {
...
@pragma('vm:prefer-inline')
_$ColorPaletteCopyWith<_ColorPalette> get copyWith => __$ColorPaletteCopyWithImpl<_ColorPalette>(this, _$identity);

@override
Map<String, dynamic> toJson() {
  return _$ColorPaletteToJson(this, );
}
...
/// @nodoc
abstract mixin class _$ColorPaletteCopyWith<$Res> implements $ColorPaletteCopyWith<$Res> {
  factory _$ColorPaletteCopyWith(_ColorPalette value, $Res Function(_ColorPalette) _then) = __$ColorPaletteCopyWithImpl;
@override @useResult
$Res call({
@ColorJsonConverter() List<SRGBColor> colors
});
...
/// Create a copy of ColorPalette
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? colors = null,}) {
...
@Uint8ListJsonConverter() Uint8List? get thumbnail; List<PadElement> get elements;
/// Create a copy of ButterflyComponent
/// with the given fields replaced by the non-null parameter values.
@JsonKey(includeFromJson: false, includeToJson: false)
@pragma('vm:prefer-inline')
$ButterflyComponentCopyWith<ButterflyComponent> get copyWith => _$ButterflyComponentCopyWithImpl<ButterflyComponent>(this as ButterflyComponent, _$identity);
...
/// @nodoc
abstract mixin class $ButterflyComponentCopyWith<$Res> implements $PackAssetCopyWith<$Res> {
  factory $ButterflyComponentCopyWith(ButterflyComponent value, $Res Function(ButterflyComponent) _then) = _$ButterflyComponentCopyWithImpl;
@useResult
$Res call({
@Uint8ListJsonConverter() Uint8List? thumbnail, List<PadElement> elements
});
...
@override@JsonKey() List<PadElement> get elements {
...
@override @JsonKey(includeFromJson: false, includeToJson: false)
@pragma('vm:prefer-inline')
_$ButterflyComponentCopyWith<_ButterflyComponent> get copyWith => __$ButterflyComponentCopyWithImpl<_ButterflyComponent>(this, _$identity);

@override
Map<String, dynamic> toJson() {
  return _$ButterflyComponentToJson(this, );
}
...
/// @nodoc
abstract mixin class _$ButterflyComponentCopyWith<$Res> implements $ButterflyComponentCopyWith<$Res> {
  factory _$ButterflyComponentCopyWith(_ButterflyComponent value, $Res Function(_ButterflyComponent) _then) = __$ButterflyComponentCopyWithImpl;
@override @useResult
$Res call({
@Uint8ListJsonConverter() Uint8List? thumbnail, List<PadElement> elements
});
...
/// Create a copy of ButterflyComponent
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? thumbnail = freezed,Object? elements = null,}) {
  return _then(_ButterflyComponent(
thumbnail: freezed == thumbnail ? _self.thumbnail : thumbnail // ignore: cast_nullable_to_non_nullable
as Uint8List?,elements: null == elements ? _self._elements : elements // ignore: cast_nullable_to_non_nullable
as List<PadElement>,
  ));
}
...
ButterflyParameter _$ButterflyParameterFromJson(
  Map<String, dynamic> json
) {
        switch (json['type']) {
                  case 'text':
          return TextParameter.fromJson(
            json
          );
                case 'color':
          return ColorParameter.fromJson(
            json
          );
                case 'bool':
          return BoolParameter.fromJson(
            json
          );
                case 'int':
          return IntParameter.fromJson(
            json
          );
                case 'double':
          return DoubleParameter.fromJson(
            json
          );
...
mixin _$ButterflyParameter {
 ...
 int get child; String get name; Object get value;
/// Create a copy of ButterflyParameter
/// with the given fields replaced by the non-null parameter values.
@JsonKey(includeFromJson: false, includeToJson: false)
@pragma('vm:prefer-inline')
$ButterflyParameterCopyWith<ButterflyParameter> get copyWith => _$ButterflyParameterCopyWithImpl<ButterflyParameter>(this as ButterflyParameter, _$identity);
...
abstract mixin class $ButterflyParameterCopyWith<$Res>  {
  factory $ButterflyParameterCopyWith(ButterflyParameter value, $Res Function(ButterflyParameter) _then) = _$ButterflyParameterCopyWithImpl;
@useResult
$Res call({
...
/// Create a copy of ButterflyParameter
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? child = null,Object? name = null,}) {
...
@override @JsonKey(includeFromJson: false, includeToJson: false)
@pragma('vm:prefer-inline')
$TextParameterCopyWith<TextParameter> get copyWith => _$TextParameterCopyWithImpl<TextParameter>(this, _$identity);

@override
Map<String, dynamic> toJson() {
  return _$TextParameterToJson(this, );
}
...
/// @nodoc
abstract mixin class $TextParameterCopyWith<$Res> implements $ButterflyParameterCopyWith<$Res> {
  factory $TextParameterCopyWith(TextParameter value, $Res Function(TextParameter) _then) = _$TextParameterCopyWithImpl;
@override @useResult
$Res call({
 int child, String name, String value
});
...
/// Create a copy of ButterflyParameter
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? child = null,Object? name = null,Object? value = null,}) {
...
@override @JsonKey(includeFromJson: false, includeToJson: false)
@pragma('vm:prefer-inline')
$ColorParameterCopyWith<ColorParameter> get copyWith => _$ColorParameterCopyWithImpl<ColorParameter>(this, _$identity);

@override
Map<String, dynamic> toJson() {
  return _$ColorParameterToJson(this, );
}
...
/// @nodoc
abstract mixin class $ColorParameterCopyWith<$Res> implements $ButterflyParameterCopyWith<$Res> {
  factory $ColorParameterCopyWith(ColorParameter value, $Res Function(ColorParameter) _then) = _$ColorParameterCopyWithImpl;
@override @useResult
$Res call({
 int child, String name, int value
});
...
@override @JsonKey(includeFromJson: false, includeToJson: false)
@pragma('vm:prefer-inline')
$BoolParameterCopyWith<BoolParameter> get copyWith => _$BoolParameterCopyWithImpl<BoolParameter>(this, _$identity);

@override
Map<String, dynamic> toJson() {
  return _$BoolParameterToJson(this, );
}
...
/// @nodoc
abstract mixin class $BoolParameterCopyWith<$Res> implements $ButterflyParameterCopyWith<$Res> {
  factory $BoolParameterCopyWith(BoolParameter value, $Res Function(BoolParameter) _then) = _$BoolParameterCopyWithImpl;
@override @useResult
$Res call({
 int child, String name, bool value
});
...
@override @JsonKey(includeFromJson: false, includeToJson: false)
@pragma('vm:prefer-inline')
$IntParameterCopyWith<IntParameter> get copyWith => _$IntParameterCopyWithImpl<IntParameter>(this, _$identity);

@override
Map<String, dynamic> toJson() {
  return _$IntParameterToJson(this, );
}
...
/// @nodoc
abstract mixin class $IntParameterCopyWith<$Res> implements $ButterflyParameterCopyWith<$Res> {
  factory $IntParameterCopyWith(IntParameter value, $Res Function(IntParameter) _then) = _$IntParameterCopyWithImpl;
@override @useResult
$Res call({
 int child, String name, int value
});
...
/// @nodoc
class _$IntParameterCopyWithImpl<$Res>
    implements $IntParameterCopyWith<$Res> {
...
@override @JsonKey(includeFromJson: false, includeToJson: false)
@pragma('vm:prefer-inline')
$DoubleParameterCopyWith<DoubleParameter> get copyWith => _$DoubleParameterCopyWithImpl<DoubleParameter>(this, _$identity);

@override
Map<String, dynamic> toJson() {
  return _$DoubleParameterToJson(this, );
}
...
/// @nodoc
abstract mixin class $DoubleParameterCopyWith<$Res> implements $ButterflyParameterCopyWith<$Res> {
  factory $DoubleParameterCopyWith(DoubleParameter value, $Res Function(DoubleParameter) _then) = _$DoubleParameterCopyWithImpl;
@override @useResult
$Res call({
 int child, String name, double value
});
...
class _PackAssetLocation extends PackAssetLocation {
  const _PackAssetLocation(this.namespace, this.key): super(namespace, key);
...
mixin _$NamedItem<T extends PackAsset> {
 ...
 String get name; T get item;
/// Create a copy of NamedItem
/// with the given fields replaced by the non-null parameter values.
@JsonKey(includeFromJson: false, includeToJson: false)
@pragma('vm:prefer-inline')
$NamedItemCopyWith<T, NamedItem<T>> get copyWith => _$NamedItemCopyWithImpl<T, NamedItem<T>>(this as NamedItem<T>, _$identity);
...
abstract mixin class $NamedItemCopyWith<T extends PackAsset,$Res>  {
  factory $NamedItemCopyWith(NamedItem<T> value, $Res Function(NamedItem<T>) _then) = _$NamedItemCopyWithImpl;
@useResult
$Res call({
 String name, T item
});
...
class _NamedItem<T extends PackAsset> extends NamedItem<T> {
  ...
  factory _NamedItem.fromJson(Map<String, dynamic> json,T Function(Object?) fromJsonT) => _$NamedItemFromJson(json,fromJsonT);
...
@override @JsonKey(includeFromJson: false, includeToJson: false)
@pragma('vm:prefer-inline')
_$NamedItemCopyWith<T, _NamedItem<T>> get copyWith => __$NamedItemCopyWithImpl<T, _NamedItem<T>>(this, _$identity);
...
/// @nodoc
abstract mixin class _$NamedItemCopyWith<T extends PackAsset,$Res> implements $NamedItemCopyWith<T, $Res> {
  factory _$NamedItemCopyWith(_NamedItem<T> value, $Res Function(_NamedItem<T>) _then) = __$NamedItemCopyWithImpl;
@override @useResult
$Res call({
 String name, T item
});
...
/// Create a copy of NamedItem
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? name = null,Object? item = null,}) {
