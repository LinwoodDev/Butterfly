...
@override @useResult
$Res call({
 double rotation, String collection,@IdJsonConverter() String? id,@DoublePointJsonConverter() Point<double> position, double scale, PackAssetLocation styleSheet, TextArea area, ElementConstraint constraint,@ColorJsonConverter() SRGBColor foreground, Map<String, dynamic> extra
});


$PackAssetLocationCopyWith<$Res> get styleSheet;$TextAreaCopyWith<$Res> get area;$ElementConstraintCopyWith<$Res> get constraint;
...
/// Create a copy of PadElement
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? rotation = null,Object? collection = null,Object? id = freezed,Object? position = null,Object? scale = null,Object? styleSheet = null,Object? area = null,Object? constraint = null,Object? foreground = null,Object? extra = null,}) {
...
as double,styleSheet: null == styleSheet ? _self.styleSheet : styleSheet // ignore: cast_nullable_to_non_nullable
as PackAssetLocation,area: null == area ? _self.area : area // ignore: cast_nullable_to_non_nullable
...
class MarkdownElement extends PadElement with LabelElement {
   MarkdownElement({this.rotation = 0, this.collection = '', @IdJsonConverter() this.id, @DoublePointJsonConverter() this.position = const Point(0.0, 0.0), this.scale = 1.0, this.styleSheet = const PackAssetLocation(), this.areaProperty = const AreaProperty(), required this.text, this.constraint = const ElementConstraint(size: 1000), @ColorJsonConverter() this.foreground = SRGBColor.black, final  Map<String, dynamic> extra = const {}, final  String? $type}): _extra = extra,$type = $type ?? 'markdown',super._();
...
@override @useResult
$Res call({
 double rotation, String collection,@IdJsonConverter() String? id,@DoublePointJsonConverter() Point<double> position, double scale, PackAssetLocation styleSheet, AreaProperty areaProperty, String text, ElementConstraint constraint,@ColorJsonConverter() SRGBColor foreground, Map<String, dynamic> extra
});


$PackAssetLocationCopyWith<$Res> get styleSheet;$AreaPropertyCopyWith<$Res> get areaProperty;$ElementConstraintCopyWith<$Res> get constraint;
...
/// Create a copy of PadElement
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? rotation = null,Object? collection = null,Object? id = freezed,Object? position = null,Object? scale = null,Object? styleSheet = null,Object? areaProperty = null,Object? text = null,Object? constraint = null,Object? foreground = null,Object? extra = null,}) {
...
as Point<double>,scale: null == scale ? _self.scale : scale // ignore: cast_nullable_to_non_nullable
as double,styleSheet: null == styleSheet ? _self.styleSheet : styleSheet // ignore: cast_nullable_to_non_nullable
as PackAssetLocation,areaProperty: null == areaProperty ? _self.areaProperty : areaProperty // ignore: cast_nullable_to_non_nullable
