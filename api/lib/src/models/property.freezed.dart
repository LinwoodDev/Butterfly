...
class PenProperty implements Property, PathProperty {
  const PenProperty({this.strokeWidth = 5, this.thinning = 0.4, @ColorJsonConverter() this.color = SRGBColor.black, this.fill = false, this.smoothing = 0.5, this.streamline = 0.3, final  String? $type}): $type = $type ?? 'pen';
...
@override @useResult
$Res call({
 double strokeWidth, double thinning,@ColorJsonConverter() SRGBColor color, bool fill, double smoothing, double streamline
});
...
as bool,smoothing: null == smoothing ? _self.smoothing : smoothing // ignore: cast_nullable_to_non_nullable
