...
mixin _$FileMetadata {
 ...
 int? get fileVersion; NoteFileType get type;@DateTimeJsonConverter() DateTime? get createdAt;@DateTimeJsonConverter() DateTime? get updatedAt; String get name; String get description; String get author; String get directory; String get fileName; String get version;
...
class _FileMetadata implements FileMetadata {
  const _FileMetadata({this.fileVersion, required this.type, @DateTimeJsonConverter() this.createdAt, @DateTimeJsonConverter() this.updatedAt, this.name = '', this.description = '', this.author = '', this.directory = '', this.fileName = '', this.version = ''});
