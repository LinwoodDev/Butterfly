...
class _Area extends Area {
  const _Area({this.name = '', required this.width, required this.height, @DoublePointJsonConverter() required this.position, this.isInitial = false, @ColorJsonConverter() this.color}): super(name: name, width: width, height: height, position: position, isInitial: isInitial, color: color);
