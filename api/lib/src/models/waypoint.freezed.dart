...
mixin _$Waypoint {
 ...
 String? get name;@DoublePointJsonConverter() Point<double> get position; double? get scale;
...
@useResult
$Res call({
 String? name,@DoublePointJsonConverter() Point<double> position, double? scale
});
...
class _Waypoint implements Waypoint {
  const _Waypoint(this.name, @DoublePointJsonConverter() this.position, [this.scale]);
...
/// Create a copy of Waypoint
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? name = freezed,Object? position = null,Object? scale = freezed,}) {
