...
class ImageExportOptions extends ExportOptions {
  ...
  factory ImageExportOptions.fromJson(Map<String, dynamic> json) =>
      _$ImageExportOptionsFromJson(json);
  ...
  @JsonKey(includeFromJson: false, includeToJson: false)
  @pragma('vm:prefer-inline')
  $ImageExportOptionsCopyWith<ImageExportOptions> get copyWith =>
      _$ImageExportOptionsCopyWithImpl<ImageExportOptions>(this, _$identity);

  @override
  Map<String, dynamic> toJson() {
    return _$ImageExportOptionsToJson(
      this,
    );
  }
...
/// @nodoc
abstract mixin class $ImageExportOptionsCopyWith<$Res>
    implements $ExportOptionsCopyWith<$Res> {
  factory $ImageExportOptionsCopyWith(
          ImageExportOptions value, $Res Function(ImageExportOptions) _then) =
      _$ImageExportOptionsCopyWithImpl;
  @override
  @useResult
  $Res call(
      {double width,
...
class SvgExportOptions extends ExportOptions {
  ...
  factory SvgExportOptions.fromJson(Map<String, dynamic> json) =>
      _$SvgExportOptionsFromJson(json);
  ...
  @JsonKey(includeFromJson: false, includeToJson: false)
  @pragma('vm:prefer-inline')
  $SvgExportOptionsCopyWith<SvgExportOptions> get copyWith =>
      _$SvgExportOptionsCopyWithImpl<SvgExportOptions>(this, _$identity);

  @override
  Map<String, dynamic> toJson() {
    return _$SvgExportOptionsToJson(
      this,
    );
  }
...
/// @nodoc
abstract mixin class $SvgExportOptionsCopyWith<$Res>
    implements $ExportOptionsCopyWith<$Res> {
  factory $SvgExportOptionsCopyWith(
          SvgExportOptions value, $Res Function(SvgExportOptions) _then) =
      _$SvgExportOptionsCopyWithImpl;
  @override
  @useResult
  $Res call(
      {double width, double height, double x, double y, bool renderBackground});
...
mixin _$ExportPreset {
  ...
  $ExportPresetCopyWith<ExportPreset> get copyWith =>
      _$ExportPresetCopyWithImpl<ExportPreset>(
          this as ExportPreset, _$identity);
  ...
  @override
  int get hashCode => Object.hash(
      runtimeType, name, const DeepCollectionEquality().hash(areas));
...
abstract mixin class $ExportPresetCopyWith<$Res> {
  factory $ExportPresetCopyWith(
          ExportPreset value, $Res Function(ExportPreset) _then) =
      _$ExportPresetCopyWithImpl;
  @useResult
...
class _ExportPreset implements ExportPreset {
  const _ExportPreset({this.name = '', final List<AreaPreset> areas = const []})
      : _areas = areas;
  ...
  @JsonKey(includeFromJson: false, includeToJson: false)
  @pragma('vm:prefer-inline')
  _$ExportPresetCopyWith<_ExportPreset> get copyWith =>
      __$ExportPresetCopyWithImpl<_ExportPreset>(this, _$identity);

  @override
  Map<String, dynamic> toJson() {
    return _$ExportPresetToJson(
      this,
    );
  }
...
/// @nodoc
abstract mixin class _$ExportPresetCopyWith<$Res>
    implements $ExportPresetCopyWith<$Res> {
  factory _$ExportPresetCopyWith(
          _ExportPreset value, $Res Function(_ExportPreset) _then) =
      __$ExportPresetCopyWithImpl;
  @override
  @useResult
  $Res call({String name, List<AreaPreset> areas});
}
...
mixin _$AreaPreset {
  ...
  $AreaPresetCopyWith<AreaPreset> get copyWith =>
      _$AreaPresetCopyWithImpl<AreaPreset>(this as AreaPreset, _$identity);
...
abstract mixin class $AreaPresetCopyWith<$Res> {
  factory $AreaPresetCopyWith(
          AreaPreset value, $Res Function(AreaPreset) _then) =
      _$AreaPresetCopyWithImpl;
  @useResult
...
class _AreaPreset implements AreaPreset {
  ...
  @JsonKey(includeFromJson: false, includeToJson: false)
  @pragma('vm:prefer-inline')
  _$AreaPresetCopyWith<_AreaPreset> get copyWith =>
      __$AreaPresetCopyWithImpl<_AreaPreset>(this, _$identity);

  @override
  Map<String, dynamic> toJson() {
    return _$AreaPresetToJson(
      this,
    );
  }
...
/// @nodoc
abstract mixin class _$AreaPresetCopyWith<$Res>
    implements $AreaPresetCopyWith<$Res> {
  factory _$AreaPresetCopyWith(
          _AreaPreset value, $Res Function(_AreaPreset) _then) =
      __$AreaPresetCopyWithImpl;
  @override
  @useResult
  $Res call({String page, String name, double quality, Area? area});
...
/// @nodoc
class __$AreaPresetCopyWithImpl<$Res> implements _$AreaPresetCopyWith<$Res> {
