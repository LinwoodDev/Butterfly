...
<h1 style="text-align: center; padding-bottom: 3rem; padding-top: 1rem; text-shadow: 0px 0px 5px var(--sl-color-accent);"> Butterfly, the limitless canvas for visual thinking. </h1>
