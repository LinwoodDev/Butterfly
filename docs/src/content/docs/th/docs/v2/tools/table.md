...
| ความกว้าง         | 0                     | Fixed table width; `0` uses the default width based on the columns.                                                 |
| ความสูง           | 0                     | Fixed table height; `0` uses the default height based on the rows.                                                  |
...
| เติม              | Transparent           | Table background color and alpha.                                                                                   |
| ขึ้นอยู่กับการซูม | Off                   | Changes table creation size based on the zoom level.                                                                |
