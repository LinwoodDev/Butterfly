...
| -------- | ------------- | ------------------------------------------------------------------------- |
| ขนาด     | 100           | The ruler's height.                                       |
| พื้นหลัง | ไม่ได้ตั้งค่า | Fill color of the ruler; uses the theme when unset.       |
| พื้นหน้า | ไม่ได้ตั้งค่า | Color of the ruler marks; chosen for contrast when unset. |
| มุม      | 0°            | Runtime angle control shown while the ruler is active.    |
