...
| Option     | ประเภท                                                                                        | Default | คำอธิบาย                                                                                                                                                                    |
| ---------- | --------------------------------------------------------------------------------------------- | ------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
...
| ------------- | -------------- | ------ | -------------------------- |
| enabled       | ปกติ           | ใช่    | When enabled by the user   |
| layoutOnly    | ปกติ           | ใช่    | ไม่เคย                     |
| startInLayout | เต็มหน้าจอ     | ใช่    | ไม่เคย                     |
| forced        | เต็มหน้าจอ     | ไม่    | ไม่เคย                     |
| disabled      | ปกติ           | ไม่    | ไม่เคย                     |
