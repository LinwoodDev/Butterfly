...
- Android 6.0 (API düzeyi 23) veya üzeri.
...
Click on [this link](https://play.google.com/apps/testing/dev.linwood.butterfly) to register for the [nightly](/community/nightly) version of the app. Lütfen bu sürümde hatalar olabileceğini unutmayın. Play Store sürümü, yeni bir nightly sürüm yayınlandığında otomatik olarak güncellenecektir.
