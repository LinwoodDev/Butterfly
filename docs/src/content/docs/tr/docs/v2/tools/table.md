...
| Genişlik              | 0                     | Fixed table width; `0` uses the default width based on the columns.                                                 |
| Yükseklik             | 0                     | Fixed table height; `0` uses the default height based on the rows.                                                  |
...
| Dolgu                 | Şeffaf                | Table background color and alpha.                                                                                   |
