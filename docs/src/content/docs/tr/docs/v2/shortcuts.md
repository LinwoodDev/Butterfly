...
| --------------------------: | :--------: | :---------------------------------------------------------------------------------------- |
| Çizim yaparken imleci gizle |    true    | Hides the mouse pointer while you draw, so it does not cover your stroke. |
...
|           Özellik | Varsayılan | Tanım                                                                                                       |
| ----------------: | :--------: | :---------------------------------------------------------------------------------------------------------- |
| Giriş hareketleri |    true    | Lets you move and zoom the canvas with touch gestures, even while drawing tool is selected. |
|      Eylemle taşı |    true    | Lets multi-touch gestures move the canvas instead of interacting with note content.         |
...
|              Özellik |              Values              | Tanım                                                                                                                            |
| -------------------: | :------------------------------: | :------------------------------------------------------------------------------------------------------------------------------- |
|  Sadece kalem girişi | Automatic, Always on, Always off | Prevents accidental marks from your hand or mouse when only pen input can draw.                                  |
