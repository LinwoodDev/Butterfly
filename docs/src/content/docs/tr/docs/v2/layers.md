...
Burada projedeki tüm katmanları görebilirsiniz. To create a new layer, use the Create button. To
...
|                Seçenek | Tanım                                                                             |
| ---------------------: | --------------------------------------------------------------------------------- |
|     Bir adım öne getir | Renders the selection on top of the first element in front of it. |
| Bir adım geriye gönder | Renders the selection under the first element behind it.          |
|              Öne getir | Renders the selection in front of everything else.                |
|          Arkaya gönder | Renders the selection behind everything else.                     |
