...
Alanlar, tuvalin boyutunu kısıtlamanın bir yoludur. You can create areas by using the [area tool](tools/area). Arkaplana tıklarsanız, bağlam menüsünü kullanarak alan listesi iletişim kutusunu açabilirsiniz.
