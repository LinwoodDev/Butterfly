...
| Option     | Tipus                                                                                         | Default | Descripció                                                                                                                                                                  |
| ---------- | --------------------------------------------------------------------------------------------- | ------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| guardar    | Boolean (true, false)                                                      | true    | Enable save. If disabled, only an exit button will be shown                                                                                                 |
...
| layoutOnly    | Normal         | Sí     | Mai                        |
| startInLayout | Full screen    | Sí     | Mai                        |
| forced        | Full screen    | No     | Mai                        |
| disabled      | Normal         | No     | Mai                        |
...
| Parameter          | Tipus     | Default                 | Descripció                                                                                  |
| ------------------ | --------- | ----------------------- | ------------------------------------------------------------------------------------------- |
