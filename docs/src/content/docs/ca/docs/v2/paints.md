...
| Property | Default  | Descripció                                  |
| -------- | -------- | ------------------------------------------- |
| Inicia   | `(0, 0)` | Start of the gradient axis. |
...
| Property     | Default              | Descripció                                                                    |
| ------------ | -------------------- | ----------------------------------------------------------------------------- |
| Centre       | `(0.5, 0.5)`         | Center of the outer circle, relative to the element bounds.   |
...
| Property | Default | Descripció                                                                                     |
| -------- | ------- | ---------------------------------------------------------------------------------------------- |
| Font     | Cap     | Image or SVG to use in the painted region.                                     |
