...
|          Option | Descripció                                                                        |
| --------------: | --------------------------------------------------------------------------------- |
|  Porta endavant | Renders the selection on top of the first element in front of it. |
|    Envia enrere | Renders the selection under the first element behind it.          |
| Porta al davant | Renders the selection in front of everything else.                |
|    Envia enrere | Renders the selection behind everything else.                     |
