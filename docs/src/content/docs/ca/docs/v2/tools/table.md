...
| Amplada           | 0                     | Fixed table width; `0` uses the default width based on the columns.                                                 |
| Alçada            | 0                     | Fixed table height; `0` uses the default height based on the rows.                                                  |
...
| Omplir            | Transparent           | Table background color and alpha.                                                                                   |
| Depenent del zoom | Off                   | Changes table creation size based on the zoom level.                                                                |
