...
| ---------- | ------------ | ------------------------------------------------------------------------- |
| Mida       | 100          | The ruler's height.                                       |
| Fons       | No establert | Fill color of the ruler; uses the theme when unset.       |
| Primer pla | No establert | Color of the ruler marks; chosen for contrast when unset. |
