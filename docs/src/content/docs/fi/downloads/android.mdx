...
- Android 6.0 (API taso 23) tai uudempi.
...
Click on [this link](https://play.google.com/apps/testing/dev.linwood.butterfly) to register for the [nightly](/community/nightly) version of the app. Huomaa, että tässä versiossa voi olla vikoja. Play-kaupan versio päivitetään automaattisesti, kun uusi iltainen versio on julkaistu.
