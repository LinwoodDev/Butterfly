...
:::tip[What apk pitäisikö minun käyttää?]

**Universalin** tulisi toimia kaikilla laitteilla. Jos haluat pienempi apk, käytä joka vastaa laitteesi arkkitehtuuria.
...
Klikkaa [tämä linkki](https://play.google.com/apps/testing/dev.linwood.butterfly) rekisteröityäksesi sovelluksen [nightly](/community/nightly) -versioon. Huomaa, että tässä versiossa voi olla vikoja. Play-kaupan versio päivitetään automaattisesti, kun uusi iltainen versio on julkaistu.
