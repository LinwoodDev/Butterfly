...
<CardGrid stagger>
  <Card title="Ristimäinen alustaa" icon="laptop">
  ...
  <Card title="Valitse mihin tietosi on tallennettu" icon="open-book">
...
<LinkCard title="Download today" href="/lataukset/" />
