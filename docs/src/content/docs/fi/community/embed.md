...
| kieli      | Merkkijono (..., järjestelmä, käyttäjä) | user    | Language of the document. If system, the language will be detected from the browser. If user, the language will set to the users preference |
| fileName   | String                                                                                                     |         | Display this file name in the embed title. It is visual only and does not change the document metadata                                                      |

### Full-screen modes

| Arvo          | Initial layout | Toggle | Browser/system full screen |
| ------------- | -------------- | ------ | -------------------------- |
| enabled       | Normaali       | Kyllä  | When enabled by the user   |
| layoutOnly    | Normaali       | Kyllä  | Ei Koskaan                 |
| startInLayout | Koko näyttö    | Kyllä  | Ei Koskaan                 |
| forced        | Koko näyttö    | Ei     | Ei Koskaan                 |
| disabled      | Normaali       | Ei     | Ei Koskaan                 |
...
| Parameter          | Tyyppi    | Oletus                  | Kuvaus                                                                                      |
| ------------------ | --------- | ----------------------- | ------------------------------------------------------------------------------------------- |
