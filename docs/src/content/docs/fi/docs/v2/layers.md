...
Täällä voit nähdä kaikki kerrokset projektissa. To create a new layer, use the Create button. To
...
|           Valinta | Kuvaus                                                                            |
| ----------------: | --------------------------------------------------------------------------------- |
|     Tuo eteenpäin | Renders the selection on top of the first element in front of it. |
| Lähetä taaksepäin | Renders the selection under the first element behind it.          |
|         Tuo eteen | Renders the selection in front of everything else.                |
|   Lähetä takaisin | Renders the selection behind everything else.                     |
