...
| ---------- | ---------------------------------------- | ------------------------------------------------------------------------------------------------------- |
| Väri       | Black for strokes; transparent for fills | Color of the painted region.                                                            |
...
| Ominaisuus         | Oletus                                                                | Kuvaus                                                                                                                          |
| ------------------ | --------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------- |
| Värien pysäytykset | Black at `0`; white at `1`                                            | Each stop has an offset, color, and alpha value. The offset determines where the color appears. |
...
| Ominaisuus | Oletus   | Kuvaus                                      |
| ---------- | -------- | ------------------------------------------- |
| Aloita     | `(0, 0)` | Start of the gradient axis. |
| Loppu      | `(1, 0)` | End of the gradient axis.   |
...
| Ominaisuus   | Oletus               | Kuvaus                                                                        |
| ------------ | -------------------- | ----------------------------------------------------------------------------- |
| Keskitetty   | `(0.5, 0.5)`         | Center of the outer circle, relative to the element bounds.   |
| Radius       | `0.5`                | Radius of the outer circle.                                   |
| Keskipiste   | Off; uses the center | Enable to move the inner starting point away from the center. |
...
| Ominaisuus | Oletus    | Kuvaus                                                                                         |
| ---------- | --------- | ---------------------------------------------------------------------------------------------- |
| Lähde      | Ei Mitään | Image or SVG to use in the painted region.                                     |
...
| Skaalaa    | `0.25`    | Size of the source pattern in the painted region.                              |
| Blur       | `0`       | Softens the painted edge.                                                      |
