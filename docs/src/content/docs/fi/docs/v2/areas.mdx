...
Alueet ovat keino rajoittaa kankaan kokoa. You can create areas by using the [area tool](../tools/area). Jos napsautat taustaa, voit avata alueen luettelon valintaikkunan käyttämällä konteksti-valikosta.
