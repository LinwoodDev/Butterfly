...
|        Aivojen leveys |              1              | The width of the grid lines.                                                           |
| Lähennys riippuvainen |           epätosi           | Changes the grid cell spacing and snapping behavior relative to the zoom level.        |
