...
| ---------- | ----------- | ------------------------------------------------------------------------- |
| Koko       | 100         | The ruler's height.                                       |
| Tausta     | Ei asetettu | Fill color of the ruler; uses the theme when unset.       |
| Etuala     | Ei asetettu | Color of the ruler marks; chosen for contrast when unset. |
| Kulma      | 0°          | Runtime angle control shown while the ruler is active.    |
