...
| --------------------- | --------------------- | ----------------------------------------------------------------------------------------------------------------------------------- |
| Rivit                 | 3                     | Initial number of rows.                                                                                             |
| Sarakkeet             | 3                     | Initial number of columns.                                                                                          |
| Width                 | 0                     | Fixed table width; `0` uses the default width based on the columns.                                                 |
| Korkeus               | 0                     | Fixed table height; `0` uses the default height based on the rows.                                                  |
...
| Täytä                 | Läpikuultava          | Table background color and alpha.                                                                                   |
| Lähennys riippuvainen | Pois                  | Changes table creation size based on the zoom level.                                                                |
