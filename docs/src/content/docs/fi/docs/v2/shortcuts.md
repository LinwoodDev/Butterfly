...
| ----------------------------------: | :----: | :--------------------------------------------------------------------------------------- |
| Piilota kohdistin piirroksen aikana |  true  | Piilottaa hiiren osoitin piirtäessäsi, joten se ei kata aivohalvaustasi. |
...
|     Siirrä ele |  true  | Lets multi-touch eleet siirtää kankaalle sen sijaan, että vuorovaikutuksessa huomautuksen sisällön kanssa. |
...
| ----------------------: | :------------------------------: | :------------------------------------------------------------------------------------------------------------------------------- |
|        Vain kynä syöttö | Automatic, Always on, Always off | Prevents accidental marks from your hand or mouse when only pen input can draw.                                  |
| Näytä vain kynän vaihto |            true, false           | Näyttää nopean vain kynällä -kytkimen editorissa, kun Butterfly tunnistaa kynän.                                 |
|             Ohita paine |       Never, First, Always       | Controls whether a pen pressure changes the stroke and works around inaccurate pressure readings from some pens. |
