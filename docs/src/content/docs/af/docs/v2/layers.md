...
|         Option | Beskrywing                                                                        |
| -------------: | --------------------------------------------------------------------------------- |
| Bring vorentoe | Renders the selection on top of the first element in front of it. |
| Stuur agtertoe | Renders the selection under the first element behind it.          |
|  Bring na voor | Renders the selection in front of everything else.                |
| Stuur na agter | Renders the selection behind everything else.                     |
