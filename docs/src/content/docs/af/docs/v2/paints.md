...
| Property | Default  | Beskrywing                                  |
| -------- | -------- | ------------------------------------------- |
| Begin    | `(0, 0)` | Start of the gradient axis. |
...
| Property     | Default              | Beskrywing                                                                    |
| ------------ | -------------------- | ----------------------------------------------------------------------------- |
| Middel       | `(0.5, 0.5)`         | Center of the outer circle, relative to the element bounds.   |
...
| Skaal    | `0.25`  | Size of the source pattern in the painted region.                              |
| Blur     | `0`     | Softens the painted edge.                                                      |
