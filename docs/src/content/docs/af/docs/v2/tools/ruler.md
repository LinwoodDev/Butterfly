...
| Agtergrond | Nie gestel nie | Fill color of the ruler; uses the theme when unset.       |
| Voorgrond  | Nie gestel nie | Color of the ruler marks; chosen for contrast when unset. |
