...
| Wydte          | 0                     | Fixed table width; `0` uses the default width based on the columns.                                                 |
| Hoogte         | 0                     | Fixed table height; `0` uses the default height based on the rows.                                                  |
...
| Vul            | Transparent           | Table background color and alpha.                                                                                   |
| Zoem-afhanklik | Off                   | Changes table creation size based on the zoom level.                                                                |
