...
A pack is a collection of components that can be used in the stamp tool. Puede crear su propio paquete o importar uno existente. To do this, click the top-left corner and select "Packs".
