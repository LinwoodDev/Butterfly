...
| ------------------------: | :---------: | :------------------------------------------------------------------------------------------ |
| Ocultar cursor al dibujar |     true    | Oculta el puntero del ratón mientras dibujas, por lo que no cubre el trazo. |
...
| Mover en gesto |     true    | Permite que los gestos multitáctiles muevan el lienzo en lugar de interactuar con el contenido de las notas. |
...
| Mostrar sólo alternar |            true, false           | Muestra un interruptor rápido sólo para el uso en el editor después de que Butterfly detecte un estilo.                 |
