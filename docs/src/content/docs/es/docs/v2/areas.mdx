...
Las áreas son una manera de restringir el tamaño de la tela. You can create areas by using the [area tool](tools/area). Si hace clic en el fondo puede abrir el diálogo de lista de áreas usando el menú contextual.
