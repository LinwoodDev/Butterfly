...
|         Restricción |                     falso                    | Applies the shape's size or aspect ratio constraint while drawing.                                                                                                               |
...
|            Rellenar | Solid Color (Transparent) | [Paint](../../paints/) used inside the shape. Not available for Line shapes.                                                                                     |
