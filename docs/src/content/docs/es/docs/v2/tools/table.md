...
| ------------------- | --------------------- | ----------------------------------------------------------------------------------------------------------------------------------- |
| Filas               | 3                     | Initial number of rows.                                                                                             |
| Columnas            | 3                     | Initial number of columns.                                                                                          |
...
| Rellenar            | Transparente          | Table background color and alpha.                                                                                   |
| Dependiente de zoom | Apagado               | Changes table creation size based on the zoom level.                                                                |
