...
Click on [this link](https://play.google.com/apps/testing/dev.linwood.butterfly) to register for the [nightly](/community/nightly) version of the app. Tenga en cuenta que esta versión puede tener errores. La versión Play Store se actualizará automáticamente cuando se libere una nueva versión nocturna.
