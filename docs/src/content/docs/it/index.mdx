...
<CardGrid stagger>
  <Card title="Piattaforma trasversale" icon="laptop">
  ...
  <Card title="Semplice e intuitiva" icon="puzzle">
  ...
  <Card title="Scegli dove archiviare i tuoi dati" icon="open-book">
...
<LinkCard title="Download today" href="/download/" />
