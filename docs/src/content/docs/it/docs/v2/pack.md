...
A pack is a collection of components that can be used in the stamp tool. È possibile creare il proprio pacchetto o importare uno esistente. To do this, click the top-left corner and select "Packs".
