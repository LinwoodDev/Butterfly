...
Le aree sono un modo per limitare le dimensioni della tela. You can create areas by using the [area tool](tools/area). Se si fa clic sullo sfondo è possibile aprire la finestra di dialogo elenco area utilizzando il menu di scelta rapida.
