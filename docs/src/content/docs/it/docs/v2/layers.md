...
Qui puoi vedere tutti i livelli nel progetto. To create a new layer, use the Create button. To
...
|        Opzione | Descrizione                                                                       |
| -------------: | --------------------------------------------------------------------------------- |
|         Avanti | Renders the selection on top of the first element in front of it. |
| Invia indietro | Renders the selection under the first element behind it.          |
|   Porta avanti | Renders the selection in front of everything else.                |
| Invia al retro | Renders the selection behind everything else.                     |
