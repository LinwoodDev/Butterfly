...
| --------------------- | --------------------- | ----------------------------------------------------------------------------------------------------------------------------------- |
| Riga                  | 3                     | Initial number of rows.                                                                                             |
| Colonne               | 3                     | Initial number of columns.                                                                                          |
| Larghezza             | 0                     | Fixed table width; `0` uses the default width based on the columns.                                                 |
| Altezza               | 0                     | Fixed table height; `0` uses the default height based on the rows.                                                  |
...
| Riempi                | Trasparente           | Table background color and alpha.                                                                                   |
| Dipendente dallo zoom | Off                   | Changes table creation size based on the zoom level.                                                                |
