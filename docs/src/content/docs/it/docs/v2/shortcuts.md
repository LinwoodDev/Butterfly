...
| -------------------------------------: | :---------: | :---------------------------------------------------------------------------------------------- |
| Nascondi il cursore durante il disegno |     true    | Nasconde il puntatore del mouse mentre disegni, quindi non copre il tuo tratto. |
...
|         Proprietà | Predefinito | Descrizione                                                                                                         |
| ----------------: | :---------: | :------------------------------------------------------------------------------------------------------------------ |
| Gestures di input |     true    | Lets you move and zoom the canvas with touch gestures, even while drawing tool is selected.         |
|   Sposta al gesto |     true    | Permette ai gesti multi-touch di spostare la tela invece di interagire con il contenuto delle note. |
...
| ---------------------------------: | :------------------------------: | :------------------------------------------------------------------------------------------------------------------------------- |
|                   Input solo penna | Automatic, Always on, Always off | Prevents accidental marks from your hand or mouse when only pen input can draw.                                  |
| Mostra solo penna attiva/disattiva |            true, false           | Mostra un rapido interruttore di sola penna nell'editor dopo che Butterfly rileva una penna.                     |
|                   Ignora pressione |       Never, First, Always       | Controls whether a pen pressure changes the stroke and works around inaccurate pressure readings from some pens. |
