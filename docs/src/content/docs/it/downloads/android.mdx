...
Click on [this link](https://play.google.com/apps/testing/dev.linwood.butterfly) to register for the [nightly](/nightly) version of the app. Si prega di notare che questa versione può contenere bug. La versione del Play Store verrà aggiornata automaticamente quando verrà rilasciata una nuova versione notturna.
