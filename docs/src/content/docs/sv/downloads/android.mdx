...
- Android 6.0 (API-nivå 23) eller högre.
...
Click on [this link](https://play.google.com/apps/testing/dev.linwood.butterfly) to register for the [nightly](/community/nightly) version of the app. Observera att denna version kan ha buggar. Play Store-versionen uppdateras automatiskt när en ny nattlig version släpps.
