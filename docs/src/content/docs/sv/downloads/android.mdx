...
Click on [this link](https://play.google.com/apps/testing/dev.linwood.butterfly) to register for the [nightly](/nightly) version of the app. Observera att denna version kan ha buggar. Play Store-versionen uppdateras automatiskt när en ny nattlig version släpps.
