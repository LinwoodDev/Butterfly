...
| ---------------------------: | :------: | :------------------------------------------------------------------------------- |
| Dölj markören medan du ritar |   true   | Döljer muspekaren medan du ritar, så det täcker inte din stroke. |
...
| Flytta på gest |   true   | Låter multi-touch gester flytta duken istället för att interagera med anteckningsinnehåll.  |
...
|               Egenskap |              Values              | Beskrivning                                                                                                                      |
| ---------------------: | :------------------------------: | :------------------------------------------------------------------------------------------------------------------------------- |
| Endast penna inmatning | Automatic, Always on, Always off | Prevents accidental marks from your hand or mouse when only pen input can draw.                                  |
|      Visa endast penna |            true, false           | Visar en snabb pennknapp i redigeraren efter att Butterfly upptäcker en penna.                                   |
|         Ignorera tryck |       Never, First, Always       | Controls whether a pen pressure changes the stroke and works around inaccurate pressure readings from some pens. |
