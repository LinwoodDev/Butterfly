...
A pack is a collection of components that can be used in the stamp tool. Du kan skapa ditt eget paket eller importera ett befintligt. To do this, click the top-left corner and select "Packs".
