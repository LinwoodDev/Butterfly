...
| -------- | ----------- | ------------------------------------------------------------------------- |
| Storlek  | 100         | The ruler's height.                                       |
| Bakgrund | Ej inställd | Fill color of the ruler; uses the theme when unset.       |
| Förgrund | Ej inställd | Color of the ruler marks; chosen for contrast when unset. |
