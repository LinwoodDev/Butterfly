...
| Kolumner       | 3                     | Initial number of columns.                                                                                          |
| Width          | 0                     | Fixed table width; `0` uses the default width based on the columns.                                                 |
| Höjd           | 0                     | Fixed table height; `0` uses the default height based on the rows.                                                  |
...
| Fyll           | Genomskinlig          | Table background color and alpha.                                                                                   |
| Zooma beroende | Av                    | Changes table creation size based on the zoom level.                                                                |
