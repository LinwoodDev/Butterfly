...
| Kombinera sökvägar |                                 falskt                                 | This will merge all strokes it touches into one path                                                                                    |
...
|      Effektivisera |                           0.3                          | How much the pen will follow the movement of the mouse.                                                                 |
|               Färg |                 Solid Color (Black)                 | [Customization](../../colors/#further-customization) for the color of the stroke                                                        |
|               Fyll |              Solid Color (Transparent)              | [Customization](../../colors/#further-customization) for the color drawn inside the enclosed area                                       |