...
Här kan du se alla lager i projektet. To create a new layer, use the Create button. To
...
| -------------------: | --------------------------------------------------------------------------------- |
|              Ta fram | Renders the selection on top of the first element in front of it. |
|         Skicka bakåt | Renders the selection under the first element behind it.          |
|              Ta fram | Renders the selection in front of everything else.                |
| Skicka till baksidan | Renders the selection behind everything else.                     |
