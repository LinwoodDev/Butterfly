...
| -------- | ---------------------------------------- | ------------------------------------------------------------------------------------------------------- |
| Färg     | Black for strokes; transparent for fills | Color of the painted region.                                                            |
...
| Egenskap     | Standard                                                              | Beskrivning                                                                                                                     |
| ------------ | --------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------- |
| Färg stannar | Black at `0`; white at `1`                                            | Each stop has an offset, color, and alpha value. The offset determines where the color appears. |
...
| Egenskap | Standard | Beskrivning                                 |
| -------- | -------- | ------------------------------------------- |
| Starta   | `(0, 0)` | Start of the gradient axis. |
...
| Egenskap     | Standard             | Beskrivning                                                                   |
| ------------ | -------------------- | ----------------------------------------------------------------------------- |
| Centrera     | `(0.5, 0.5)`         | Center of the outer circle, relative to the element bounds.   |
...
| Egenskap | Standard | Beskrivning                                                                                    |
| -------- | -------- | ---------------------------------------------------------------------------------------------- |
| Källa    | Ingen    | Image or SVG to use in the painted region.                                     |
