...
| -------- | ---------------------------------------- | ------------------------------------------------------------------------------------------------------- |
| Kolor    | Black for strokes; transparent for fills | Color of the painted region.                                                            |
...
| Własność           | Domyślny                                                              | Opis                                                                                                                            |
| ------------------ | --------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------- |
| Przystanki kolorów | Black at `0`; white at `1`                                            | Each stop has an offset, color, and alpha value. The offset determines where the color appears. |
...
| Własność   | Domyślny | Opis                                        |
| ---------- | -------- | ------------------------------------------- |
| Rozpocznij | `(0, 0)` | Start of the gradient axis. |
| Koniec     | `(1, 0)` | End of the gradient axis.   |
...
| Własność     | Domyślny             | Opis                                                                          |
| ------------ | -------------------- | ----------------------------------------------------------------------------- |
| Środkowy     | `(0.5, 0.5)`         | Center of the outer circle, relative to the element bounds.   |
| Radius       | `0.5`                | Radius of the outer circle.                                   |
| Punkt główny | Off; uses the center | Enable to move the inner starting point away from the center. |
...
| Własność | Domyślny | Opis                                                                                           |
| -------- | -------- | ---------------------------------------------------------------------------------------------- |
| Źródło   | Brak     | Image or SVG to use in the painted region.                                     |
...
| Skala    | `0.25`   | Size of the source pattern in the painted region.                              |
| Blur     | `0`      | Softens the painted edge.                                                      |
