...
Tutaj możesz zobaczyć wszystkie warstwy w projekcie. To create a new layer, use the Create button. To
...
|              Opcja | Opis                                                                              |
| -----------------: | --------------------------------------------------------------------------------- |
| Przenieś do przodu | Renders the selection on top of the first element in front of it. |
|     Wyślij do tyłu | Renders the selection under the first element behind it.          |
|  Przenieś na przód | Renders the selection in front of everything else.                |
|  Wyślij do powrotu | Renders the selection behind everything else.                     |
