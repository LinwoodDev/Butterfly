...
|        Szerokość obrysu |              1              | The width of the grid lines.                                                           |
| Zależny od powiększenia |           fałszywy          | Changes the grid cell spacing and snapping behavior relative to the zoom level.        |
