...
| ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ | --------------------- | ----------------------------------------------------------------------------------------------------------------------------------- |
| Wiersze                                                                                                                                                                                    | 3                     | Initial number of rows.                                                                                             |
| Kwota, którą należy zgłosić w kolumnie 060 tego wiersza: pierwotne odliczenie, art. 36 ust. 1 lit. b) CRR. | 3                     | Initial number of columns.                                                                                          |
| Width                                                                                                                                                                                      | 0                     | Fixed table width; `0` uses the default width based on the columns.                                                 |
| Wysokość                                                                                                                                                                                   | 0                     | Fixed table height; `0` uses the default height based on the rows.                                                  |
...
| Wypełnij                                                                                                                                                                                   | Przezroczysty         | Table background color and alpha.                                                                                   |
| Zależny od powiększenia                                                                                                                                                                    | Wyłączony             | Changes table creation size based on the zoom level.                                                                |
