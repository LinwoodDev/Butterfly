...
| -----------------------------: | :------: | :------------------------------------------------------------------------------------------- |
| Ukryj kursor podczas rysowania |   true   | Ukrywa wskaźnik myszy podczas rysowania, więc nie pokrywa twojego uderzenia. |
...
| Przesuń po gestach |   true   | Pozwala na przenoszenie gestów z wielu dotyków zamiast interakcji z treścią notatki.        |
...
|                 Własność |              Values              | Opis                                                                                                                             |
| -----------------------: | :------------------------------: | :------------------------------------------------------------------------------------------------------------------------------- |
| Wprowadzanie tylko pióra | Automatic, Always on, Always off | Prevents accidental marks from your hand or mouse when only pen input can draw.                                  |
|        Pokaż tylko pióro |            true, false           | Pokazuje szybki przełącznik tylko długopisów w edytorze po wykryciu długopisu.                                   |
|           Ignoruj nacisk |       Never, First, Always       | Controls whether a pen pressure changes the stroke and works around inaccurate pressure readings from some pens. |
