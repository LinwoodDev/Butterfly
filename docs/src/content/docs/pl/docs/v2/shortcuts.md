...
| Pokaż tylko przełącznik rysika |            true, false           | Pokazuje szybki przełącznik stylu tylko w edytorze po wykryciu stylu Butterfly.                                         |
|                 Ignoruj nacisk |       Never, First, Always       | Controls whether a stylus pressure changes the stroke and works around inaccurate pressure readings from some styluses. |
