...
Obszary są sposobem na ograniczenie rozmiaru płótna. You can create areas by using the [area tool](tools/area). Jeśli klikniesz w tło możesz otworzyć okno dialogowe listy obszarów za pomocą menu kontekstowego.
