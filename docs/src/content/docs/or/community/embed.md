...
| ------------- | -------------- | ------ | -------------------------- |
| enabled       | ସାଧାରଣ         | ହଁ     | When enabled by the user   |
| layoutOnly    | ସାଧାରଣ         | ହଁ     | କେବେ ନୁହେଁ                 |
| startInLayout | Full screen    | ହଁ     | କେବେ ନୁହେଁ                 |
| forced        | Full screen    | ନା     | କେବେ ନୁହେଁ                 |
| disabled      | ସାଧାରଣ         | ନା     | କେବେ ନୁହେଁ                 |
...
| Parameter          | ପ୍ରକାର    | Default                 | ବିବରଣୀ                                                                                      |
| ------------------ | --------- | ----------------------- | ------------------------------------------------------------------------------------------- |
