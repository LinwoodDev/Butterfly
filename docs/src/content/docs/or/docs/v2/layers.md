...
|          Option | ବିବରଣୀ                                                                            |
| --------------: | --------------------------------------------------------------------------------- |
|     ଆଗକୁ ଆଣନ୍ତୁ | Renders the selection on top of the first element in front of it. |
|    ପଛକୁ ପଠାନ୍ତୁ | Renders the selection under the first element behind it.          |
| ସାମ୍ନାକୁ ଆଣନ୍ତୁ | Renders the selection in front of everything else.                |
|    ପଛକୁ ପଠାନ୍ତୁ | Renders the selection behind everything else.                     |
