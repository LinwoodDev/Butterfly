...
| -------------------------------: | :-----: | :---------------------------------------------------------------------------------------- |
| ଚିତ୍ରାଙ୍କନ କାଳୀନ କର୍ସର୍ ଲୁଚାନ୍ତୁ |   true  | Hides the mouse pointer while you draw, so it does not cover your stroke. |
...
|           Property | Default | ବିବରଣୀ                                                                                                      |
| -----------------: | :-----: | :---------------------------------------------------------------------------------------------------------- |
| ଇନ୍ପୁଟ୍ ଇଶାରାଗୁଡିକ |   true  | Lets you move and zoom the canvas with touch gestures, even while drawing tool is selected. |
|    ଇଶାରାରେ ସରାନ୍ତୁ |   true  | Lets multi-touch gestures move the canvas instead of interacting with note content.         |
...
|             Property |              Values              | ବିବରଣୀ                                                                                                                           |
| -------------------: | :------------------------------: | :------------------------------------------------------------------------------------------------------------------------------- |
|    କଳମ ମାତ୍ର ଇନ୍ପୁଟ୍ | Automatic, Always on, Always off | Prevents accidental marks from your hand or mouse when only pen input can draw.                                  |
