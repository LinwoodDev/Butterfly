...
| ପ୍ରସ୍ଥ      | 0                     | Fixed table width; `0` uses the default width based on the columns.                                                 |
| ଉଚ୍ଚତା      | 0                     | Fixed table height; `0` uses the default height based on the rows.                                                  |
...
| ପୂରଣ        | Transparent           | Table background color and alpha.                                                                                   |
| ଜୁମ୍ ନିର୍ଭର | Off                   | Changes table creation size based on the zoom level.                                                                |
