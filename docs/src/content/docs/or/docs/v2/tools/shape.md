...
|      ନିବନ୍ଧନ |                     false                    | Applies the shape's size or aspect ratio constraint while drawing.                                                                                                                |
...
|         ରଙ୍ଗ |    Solid Color (Black)    | [Paint](../../paints/) used for the shape outline.                                                                                                                                |
|        ଆକୃତି |                      ଆୟତ                     | The shape that will be drawn. Available shapes are Rectangle, Triangle, Circle and Line                                                                                           |
| କୋନ୍ ରୌଦ୍ରତା |                  0, 0, 0, 0                  | The radius of the corners when shape is Rectangle                                                                                                                                                 |
|         ପୂରଣ | Solid Color (Transparent) | [Paint](../../paints/) used inside the shape. Not available for Line shapes.                                                                                      |
