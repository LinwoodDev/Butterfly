...
| Værdi         | Initial layout | Toggle | Browser/system full screen |
| ------------- | -------------- | ------ | -------------------------- |
| enabled       | Normal         | Ja     | When enabled by the user   |
| layoutOnly    | Normal         | Ja     | Aldrig                     |
| startInLayout | Fuld skærm     | Ja     | Aldrig                     |
| forced        | Fuld skærm     | Nej    | Aldrig                     |
| disabled      | Normal         | Nej    | Aldrig                     |
...
| Parameter          | Type      | Standard                | Varebeskrivelse                                                                             |
| ------------------ | --------- | ----------------------- | ------------------------------------------------------------------------------------------- |
