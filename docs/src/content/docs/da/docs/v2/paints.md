...
| ----------- | ----------------------------------------------------------------------- | ------------------------------------------------------------------ |
| Solid farve | Uses one color throughout the stroke or fill.           | Color, alpha, blur.                                |
| Overgang    | Blends between color stops.                             | Linear or radial layout, color stops, alpha, blur. |
| Billede     | Repeats an imported raster image in the painted region. | Source image, tint, alpha, scale, blur.            |
