...
| Command                                      | Varebeskrivelse                                                                  | Example                                                             | Example command                           |
| -------------------------------------------- | -------------------------------------------------------------------------------- | ------------------------------------------------------------------- | ----------------------------------------- |
...
|      Forgrund |   Sort   | The text color.                                                        |
|        Skaler |     2    | The scale of the label.                                                |
| Zoom afhængig |   falsk  | Changes the label size based on the zoom level.                        |
