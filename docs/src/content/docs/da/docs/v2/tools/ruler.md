...
| --------- | ------------ | ------------------------------------------------------------------------- |
| Størrelse | 100          | The ruler's height.                                       |
| Baggrund  | Ikke angivet | Fill color of the ruler; uses the theme when unset.       |
| Forgrund  | Ikke angivet | Color of the ruler marks; chosen for contrast when unset. |
| Vinkel    | 0°           | Runtime angle control shown while the ruler is active.    |
