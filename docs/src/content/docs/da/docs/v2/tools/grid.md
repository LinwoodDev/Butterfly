...
|         Slaglængde |              1              | The width of the grid lines.                                                           |
|      Zoom afhængig |            falsk            | Changes the grid cell spacing and snapping behavior relative to the zoom level.        |
| Placering afhængig |            falsk            | Makes the grid depend on the canvas position instead of staying fixed on the viewport. |
