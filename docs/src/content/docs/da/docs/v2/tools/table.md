...
| ------------- | --------------------- | ----------------------------------------------------------------------------------------------------------------------------------- |
| Rækker        | 3                     | Initial number of rows.                                                                                             |
| Kolonner      | 3                     | Initial number of columns.                                                                                          |
...
| Udfyld        | Gennemsigtig          | Table background color and alpha.                                                                                   |
| Zoom afhængig | Fra                   | Changes table creation size based on the zoom level.                                                                |
