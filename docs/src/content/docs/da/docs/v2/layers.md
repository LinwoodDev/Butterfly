...
Her kan du se alle lag i projektet. To create a new layer, use the Create button. To
...
| -----------------: | --------------------------------------------------------------------------------- |
|       Bring fremad | Renders the selection on top of the first element in front of it. |
|       Send tilbage | Renders the selection under the first element behind it.          |
| Bring til forsiden | Renders the selection in front of everything else.                |
|   Send til tilbage | Renders the selection behind everything else.                     |
