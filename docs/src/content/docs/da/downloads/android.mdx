...
:::tip[What apk skal jeg bruge?]

**Universel** bør virke på alle enheder. Hvis du vil have en mindre apk, så brug den, der matcher enhedens arkitektur.
...
Klik på [dette link](https://play.google.com/apps/testing/dev.linwood.butterfly) for at tilmelde dig app'ens [nightly](/community/nighly) version. Bemærk, at denne version kan have fejl. Afspilningsbutikkens version opdateres automatisk, når en ny natlig version frigives.
