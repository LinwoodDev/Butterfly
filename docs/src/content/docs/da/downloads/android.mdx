...
Click on [this link](https://play.google.com/apps/testing/dev.linwood.butterfly) to register for the [nightly](/nightly) version of the app. Bemærk, at denne version kan have fejl. Afspilningsbutikkens version opdateres automatisk, når en ny natlig version frigives.
