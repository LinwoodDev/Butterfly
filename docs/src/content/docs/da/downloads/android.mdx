...
- Android 6.0 (API niveau 23) eller højere.
...
Click on [this link](https://play.google.com/apps/testing/dev.linwood.butterfly) to register for the [nightly](/community/nightly) version of the app. Bemærk, at denne version kan have fejl. Afspilningsbutikkens version opdateres automatisk, når en ny natlig version frigives.
