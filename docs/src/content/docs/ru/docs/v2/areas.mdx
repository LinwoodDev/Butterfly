...
Площади - это способ ограничить размер холста. You can create areas by using the [area tool](../tools/area). При нажатии на фон вы можете открыть диалоговое окно списка области с помощью контекстного меню.
