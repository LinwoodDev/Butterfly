...
| -------------------------------: | :----------: | :------------------------------------------------------------------------------------------------- |
| Скрыть курсор во время рисования |     true     | Скрывает указатель мыши при наведении курсора, так что он не охватывает ваш штрих. |
...
|         Свойства | По умолчанию | Описание                                                                                                      |
| ---------------: | :----------: | :------------------------------------------------------------------------------------------------------------ |
|      Жесты ввода |     true     | Lets you move and zoom the canvas with touch gestures, even while drawing tool is selected.   |
| Переместить жест |     true     | Позволяет многокасательно жестов перемещать холст вместо взаимодействия с содержимым заметок. |
...
|                             Свойства |              Values              | Описание                                                                                                                         |
| -----------------------------------: | :------------------------------: | :------------------------------------------------------------------------------------------------------------------------------- |
|                    Только ввод ручки | Automatic, Always on, Always off | Prevents accidental marks from your hand or mouse when only pen input can draw.                                  |
| Показывать переключатель только пера |            true, false           | Показывает быстрый переключатель только ручки в редакторе после обнаружения Бабочки.                             |
|                Игнорировать давление |       Never, First, Always       | Controls whether a pen pressure changes the stroke and works around inaccurate pressure readings from some pens. |
