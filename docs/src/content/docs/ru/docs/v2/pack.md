...
A pack is a collection of components that can be used in the stamp tool. Вы можете создать свой собственный пакет или импортировать уже существующий. To do this, click the top-left corner and select "Packs".
