...
Здесь вы можете увидеть все слои в проекте. Для создания нового слоя, нажмите кнопку Создать. To
...
|                  Вариант | Описание                                                                          |
| -----------------------: | --------------------------------------------------------------------------------- |
|           Перенос вперед | Renders the selection on top of the first element in front of it. |
|          Отправить назад | Renders the selection under the first element behind it.          |
| Вывести на передний план | Renders the selection in front of everything else.                |
| Отправить на задний план | Renders the selection behind everything else.                     |
