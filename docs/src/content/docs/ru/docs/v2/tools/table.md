...
| ----------------------- | --------------------- | ----------------------------------------------------------------------------------------------------------------------------------- |
| Строки                  | 3                     | Initial number of rows.                                                                                             |
| Столбцы                 | 3                     | Initial number of columns.                                                                                          |
| Ширина                  | 0                     | Fixed table width; `0` uses the default width based on the columns.                                                 |
| Высота                  | 0                     | Fixed table height; `0` uses the default height based on the rows.                                                  |
...
| Заполнить               | Прозрачный            | Table background color and alpha.                                                                                   |
| Зависимость от масштаба | Выкл                  | Changes table creation size based on the zoom level.                                                                |
