...
| ------------- | ------------ | ------------------------------------------------------------------------- |
| Размер        | 100          | The ruler's height.                                       |
| Фон           | Не задано    | Fill color of the ruler; uses the theme when unset.       |
| Передний план | Не задано    | Color of the ruler marks; chosen for contrast when unset. |
| Угол          | 0°           | Runtime angle control shown while the ruler is active.    |
