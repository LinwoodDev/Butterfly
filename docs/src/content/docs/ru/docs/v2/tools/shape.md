...
|             Ограничение |                     ложь                     | Applies the shape's size or aspect ratio constraint while drawing.                                                                                                                                          |
...
|                    Цвет |    Solid Color (Black)    | [Paint](../../paints/) used for the shape outline.                                                                                                                                                          |
...
|               Заполнить | Solid Color (Transparent) | [Paint](../../paints/) used inside the shape. Not available for Line shapes.                                                                                                                |
