...
:::tip[What apk должен использовать?]

**Универсальный** должен работать на всех устройствах. Если вы хотите меньшего apk, используйте тот, который соответствует архитектуре вашего устройства.
...
Нажмите по [этой ссылке](https://play.google.com/apps/testing/dev.linwood.butterfly) для регистрации версии [nightly](/community/nightly) приложения. Пожалуйста, обратите внимание, что эта версия может содержать ошибки. Версия плей-магазина будет автоматически обновляться при выпуске новой ночной версии.
