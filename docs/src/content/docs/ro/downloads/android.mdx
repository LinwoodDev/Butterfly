...
Click on [this link](https://play.google.com/apps/testing/dev.linwood.butterfly) to register for the [nightly](/nightly) version of the app. Vă rugăm să reţineţi că această versiune poate avea erori. Versiunea de magazin joaca va fi actualizată automat atunci când o nouă versiune nocturnă este lansată.
