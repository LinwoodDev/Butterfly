...
A pack is a collection of components that can be used in the stamp tool. Puteți crea propriul pachet sau să importați unul existent. To do this, click the top-left corner and select "Packs".
