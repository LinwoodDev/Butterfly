...
Zonele reprezintă o modalitate de a limita dimensiunea pânzilor. You can create areas by using the [area tool](../tools/area). Dacă faceţi clic pe fundal puteţi deschide lista de zone folosind meniul contextual.
