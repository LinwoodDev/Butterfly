...
| -----------------------------------: | :------: | :----------------------------------------------------------------------------------------------------- |
| Ascunde cursorul în timpul desenării |   true   | Ascunde cursorul mouse-ului în timp ce desenezi, astfel încât să nu acopere șmecheria. |
...
|   Mută la gest |   true   | Lasă gesturi multi-touch să mute pânza în loc să interacționeze cu conținutul notei.        |
...
|                           Proprietate |              Values              | Descriere                                                                                                                        |
| ------------------------------------: | :------------------------------: | :------------------------------------------------------------------------------------------------------------------------------- |
| Numai introducerea stiloului injector | Automatic, Always on, Always off | Prevents accidental marks from your hand or mouse when only pen input can draw.                                  |
|    Arată doar comutator pentru stilou |            true, false           | Afișează un buton doar rapid în editor după ce Butterfly detectează un stilou.                                   |
|                      Ignoră presiunea |       Never, First, Always       | Controls whether a pen pressure changes the stroke and works around inaccurate pressure readings from some pens. |
