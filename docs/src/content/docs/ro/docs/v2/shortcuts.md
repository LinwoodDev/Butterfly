...
| Arată doar comutator stylus |            true, false           | Arată un întrerupător rapid doar de stylus în editor după ce Butterfly detectează un stylus.                            |
|            Ignoră presiunea |       Never, First, Always       | Controls whether a stylus pressure changes the stroke and works around inaccurate pressure readings from some styluses. |
