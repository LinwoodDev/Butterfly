...
| ----------- | ---------------------------------------- | ------------------------------------------------------------------------------------------------------- |
| Culoare     | Black for strokes; transparent for fills | Color of the painted region.                                                            |
...
| Proprietate    | Implicit                                                              | Descriere                                                                                                                       |
| -------------- | --------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------- |
| Oprire culoare | Black at `0`; white at `1`                                            | Each stop has an offset, color, and alpha value. The offset determines where the color appears. |
...
| Proprietate | Implicit | Descriere                                   |
| ----------- | -------- | ------------------------------------------- |
| Pornire     | `(0, 0)` | Start of the gradient axis. |
| Sfârșit     | `(1, 0)` | End of the gradient axis.   |
...
| Proprietate  | Implicit             | Descriere                                                                     |
| ------------ | -------------------- | ----------------------------------------------------------------------------- |
| Centru       | `(0.5, 0.5)`         | Center of the outer circle, relative to the element bounds.   |
| Radius       | `0.5`                | Radius of the outer circle.                                   |
| Punct focal  | Off; uses the center | Enable to move the inner starting point away from the center. |
...
| Proprietate | Implicit | Descriere                                                                                      |
| ----------- | -------- | ---------------------------------------------------------------------------------------------- |
| Sursa       | Niciunul | Image or SVG to use in the painted region.                                     |
