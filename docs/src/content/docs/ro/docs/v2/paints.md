...
| -------------- | ----------------------------------------------------------------------- | ------------------------------------------------------------------ |
| Culoare solidă | Uses one color throughout the stroke or fill.           | Color, alpha, blur.                                |
| Gradient       | Blends between color stops.                             | Linear or radial layout, color stops, alpha, blur. |
| Imagine        | Repeats an imported raster image in the painted region. | Source image, tint, alpha, scale, blur.            |
| VSG            | Uses an imported SVG as the paint source.               | Source SVG, tint, alpha, scale, blur.              |
