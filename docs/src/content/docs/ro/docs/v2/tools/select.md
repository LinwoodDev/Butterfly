...
| Selectați când atingeți marginile | The shape will be selected when the selected area intersects any edge.      |
|   Selectați când atingeți oriunde | The shape will be selected when any part of it is inside the selected area. |
