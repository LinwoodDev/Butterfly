...
| --------------- | --------------------- | ----------------------------------------------------------------------------------------------------------------------------------- |
| Rânduri         | 3                     | Initial number of rows.                                                                                             |
| Coloane         | 3                     | Initial number of columns.                                                                                          |
| Width           | 0                     | Fixed table width; `0` uses the default width based on the columns.                                                 |
| Înălțime        | 0                     | Fixed table height; `0` uses the default height based on the rows.                                                  |
...
| Completează     | Transparență          | Table background color and alpha.                                                                                   |
| Depinde de zoom | Dezactivat            | Changes table creation size based on the zoom level.                                                                |
