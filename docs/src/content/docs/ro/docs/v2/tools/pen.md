...
|    Combinați căile |                                  fals                                  | This will merge all strokes it touches into one path                                                                                    |
...
|      Raţionalizare |                           0.3                          | How much the pen will follow the movement of the mouse.                                                                 |
|            Culoare |                 Solid Color (Black)                 | [Customization](../../colors/#further-customization) for the color of the stroke                                                        |
|        Completează |              Solid Color (Transparent)              | [Customization](../../colors/#further-customization) for the color drawn inside the enclosed area                                       |