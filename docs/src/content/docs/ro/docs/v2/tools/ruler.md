...
| ----------- | ------------- | ------------------------------------------------------------------------- |
| Dimensiune  | 100           | The ruler's height.                                       |
| Context     | Nu este setat | Fill color of the ruler; uses the theme when unset.       |
| prim-plan   | Nu este setat | Color of the ruler marks; chosen for contrast when unset. |
| Unghiul     | 0°            | Runtime angle control shown while the ruler is active.    |
