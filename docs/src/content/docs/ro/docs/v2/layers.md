...
Aici puteţi vedea toate straturile din proiect. To create a new layer, use the Create button. To
...
|        Opţiune | Descriere                                                                         |
| -------------: | --------------------------------------------------------------------------------- |
|    Adu înainte | Renders the selection on top of the first element in front of it. |
| Trimite înapoi | Renders the selection under the first element behind it.          |
|  Aduce în față | Renders the selection in front of everything else.                |
| Trimite înapoi | Renders the selection behind everything else.                     |
