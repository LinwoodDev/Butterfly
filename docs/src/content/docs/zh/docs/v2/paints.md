...
| ---------- | ----------------------------------------------------------------------- | ------------------------------------------------------------------ |
| 实心颜色       | Uses one color throughout the stroke or fill.           | Color, alpha, blur.                                |
| 渐变         | Blends between color stops.                             | Linear or radial layout, color stops, alpha, blur. |
| 图片         | Repeats an imported raster image in the painted region. | Source image, tint, alpha, scale, blur.            |
