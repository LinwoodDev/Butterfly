...
在这里你可以看到项目中的所有图层。 在这里你可以看到项目中的所有图层。 To create a new layer, use the Create button. To show or hide a layer, use the eye button. To reorder the layers, click and drag the handle on the right. You can also delete, rename, or duplicate a layer by right-clicking the layer or selecting the three dots.