...
| 宽度     | 0                     | Fixed table width; `0` uses the default width based on the columns.                                                 |
| 高度     | 0                     | Fixed table height; `0` uses the default height based on the rows.                                                  |
...
| 填充     | 透明的                   | Table background color and alpha.                                                                                   |
| 依靠缩放   | 关闭                    | Changes table creation size based on the zoom level.                                                                |
