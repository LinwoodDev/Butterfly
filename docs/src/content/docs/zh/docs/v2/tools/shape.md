...
| 制约因素 |                     false                    | Applies the shape's size or aspect ratio constraint while drawing.                           |
|   宽度 |                       0                      | 区域的固定宽度。如果设置为 0，宽度将自动计算。                                                                                     |
|   高度 |                       0                      | 区域的固定高度区域的固定高度 如果设置为 0，高度将自动计算。                                                                              |
...
|   颜色 |    Solid Color (Black)    | [Paint](../../paints/) used for the shape outline.                                           |
...
|   填充 | Solid Color (Transparent) | [Paint](../../paints/) used inside the shape. Not available for Line shapes. |
