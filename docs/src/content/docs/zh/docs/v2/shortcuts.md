...
|      属性 | 默认设置 | 描述                      |
| ------: | :--: | :---------------------- |
| 绘制时隐藏光标 | true | 当您绘制时隐藏鼠标指针，所以它不覆盖您的笔划。 |
...
|   属性 | 默认设置 | 描述                                                                                                          |
| ---: | :--: | :---------------------------------------------------------------------------------------------------------- |
| 输入手势 | true | Lets you move and zoom the canvas with touch gestures, even while drawing tool is selected. |
| 手势移动 | true | 让多点触摸手势移动画布，而不是与笔记内容交互。                                                                                     |
...
|      属性 |              Values              | 描述                                                                                                                               |
| ------: | :------------------------------: | :------------------------------------------------------------------------------------------------------------------------------- |
|   只输入笔数 | Automatic, Always on, Always off | Prevents accidental marks from your hand or mouse when only pen input can draw.                                  |
| 只显示画笔开关 |            true, false           | Butterfight 检测到笔刷后在编辑器中显示一个快速的纯笔开关。                                                                                              |
|    忽略压力 |       Never, First, Always       | Controls whether a pen pressure changes the stroke and works around inaccurate pressure readings from some pens. |
