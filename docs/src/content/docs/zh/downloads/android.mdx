...
Click on [this link](https://play.google.com/apps/testing/dev.linwood.butterfly) to register for the [nightly](/nightly) version of the app. 请注意，这个版本可能有漏洞。 当发布新的夜间版本时，播放商店版本将自动更新。
