...
| ------------- | -------------- | ------ | -------------------------- |
| enabled       | सामान्य        | हाँ    | When enabled by the user   |
| layoutOnly    | सामान्य        | हाँ    | कभी नहीँ                   |
| startInLayout | Full screen    | हाँ    | कभी नहीँ                   |
| forced        | Full screen    | नहीं   | कभी नहीँ                   |
| disabled      | सामान्य        | नहीं   | कभी नहीँ                   |
...
| Parameter          | प्रकार    | Default                 | विवरण                                                                                       |
| ------------------ | --------- | ----------------------- | ------------------------------------------------------------------------------------------- |
