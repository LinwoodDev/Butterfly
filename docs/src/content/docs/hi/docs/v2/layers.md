...
|     Option | विवरण                                                                             |
| ---------: | --------------------------------------------------------------------------------- |
|   आगे लाएं | Renders the selection on top of the first element in front of it. |
| पीछे भेजें | Renders the selection under the first element behind it.          |
| सामने लाएं | Renders the selection in front of everything else.                |
| पीछे भेजें | Renders the selection behind everything else.                     |
