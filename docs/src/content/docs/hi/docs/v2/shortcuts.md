...
| ----------------------------: | :-----: | :---------------------------------------------------------------------------------------- |
| ड्राइंग करते समय कर्सर छिपाएं |   true  | Hides the mouse pointer while you draw, so it does not cover your stroke. |
...
|          Property | Default | विवरण                                                                                                       |
| ----------------: | :-----: | :---------------------------------------------------------------------------------------------------------- |
|      इनपुट जेस्चर |   true  | Lets you move and zoom the canvas with touch gestures, even while drawing tool is selected. |
| जेस्चर पर ले जाएं |   true  | Lets multi-touch gestures move the canvas instead of interacting with note content.         |
...
|             Property |              Values              | विवरण                                                                                                                            |
| -------------------: | :------------------------------: | :------------------------------------------------------------------------------------------------------------------------------- |
|       केवल पेन इनपुट | Automatic, Always on, Always off | Prevents accidental marks from your hand or mouse when only pen input can draw.                                  |
