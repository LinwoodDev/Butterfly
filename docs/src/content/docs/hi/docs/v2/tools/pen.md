...
|       स्ट्रीमलाइन |                           0.3                          | How much the pen will follow the movement of the mouse.                                                                 |
|             Color |                 Solid Color (Black)                 | [Customization](../../colors/#further-customization) for the color of the stroke                                                        |
|              भरें |              Solid Color (Transparent)              | [Customization](../../colors/#further-customization) for the color drawn inside the enclosed area                                       |