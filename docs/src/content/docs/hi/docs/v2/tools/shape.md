...
|              बाधा |                     false                    | Applies the shape's size or aspect ratio constraint while drawing.                                                                                                                |
...
|             आकृति |                      आयत                     | The shape that will be drawn. Available shapes are Rectangle, Triangle, Circle and Line                                                                                           |
|  कोने की त्रिज्या |                  0, 0, 0, 0                  | The radius of the corners when shape is Rectangle                                                                                                                                                 |
|              भरें | Solid Color (Transparent) | [Paint](../../paints/) used inside the shape. Not available for Line shapes.                                                                                      |
