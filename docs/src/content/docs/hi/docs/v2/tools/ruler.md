...
| --------- | ----------- | ------------------------------------------------------------------------- |
| आकार      | 100         | The ruler's height.                                       |
| पृष्ठभूमि | सेट नहीं है | Fill color of the ruler; uses the theme when unset.       |
| अग्रभूमि  | सेट नहीं है | Color of the ruler marks; chosen for contrast when unset. |
| कोण       | 0°          | Runtime angle control shown while the ruler is active.    |
