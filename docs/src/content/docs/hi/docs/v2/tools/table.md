...
| चौड़ाई         | 0                     | Fixed table width; `0` uses the default width based on the columns.                                                 |
| ऊंचाई          | 0                     | Fixed table height; `0` uses the default height based on the rows.                                                  |
...
| भरें           | Transparent           | Table background color and alpha.                                                                                   |
| ज़ूम पर निर्भर | Off                   | Changes table creation size based on the zoom level.                                                                |
