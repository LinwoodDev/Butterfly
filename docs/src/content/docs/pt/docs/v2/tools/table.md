...
| ----------------------- | --------------------- | ----------------------------------------------------------------------------------------------------------------------------------- |
| Linhas                  | 3                     | Initial number of rows.                                                                                             |
| Colunas                 | 3                     | Initial number of columns.                                                                                          |
| Largura                 | 0                     | Fixed table width; `0` uses the default width based on the columns.                                                 |
| Altura                  | 0                     | Fixed table height; `0` uses the default height based on the rows.                                                  |
...
| Preencher               | Transparente          | Table background color and alpha.                                                                                   |
| Dependente da ampliação | Desligado             | Changes table creation size based on the zoom level.                                                                |
