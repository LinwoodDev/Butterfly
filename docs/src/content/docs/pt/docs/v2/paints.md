...
| ---------- | ----------------------------------------------------------------------- | ------------------------------------------------------------------ |
| Cor sólida | Uses one color throughout the stroke or fill.           | Color, alpha, blur.                                |
| Degradê    | Blends between color stops.                             | Linear or radial layout, color stops, alpha, blur. |
| Imagem     | Repeats an imported raster image in the painted region. | Source image, tint, alpha, scale, blur.            |
