...
As áreas são uma forma de restringir a dimensão da tela. You can create areas by using the [area tool](tools/area). Se você clicar em segundo plano você pode abrir a lista de áreas usando o menu de contexto.
