...
| Option     | 類型                                                                                            | Default | 說明                                                                                                                                                                          |
| ---------- | --------------------------------------------------------------------------------------------- | ------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| 儲存         | Boolean (true, false)                                                      | true    | Enable save. If disabled, only an exit button will be shown                                                                                                 |
...
| ------------- | -------------- | ------ | -------------------------- |
| enabled       | 標準             | 是      | When enabled by the user   |
| layoutOnly    | 標準             | 是      | 永不                         |
| startInLayout | 全螢幕            | 是      | 永不                         |
| forced        | 全螢幕            | 否      | 永不                         |
| disabled      | 標準             | 否      | 永不                         |
