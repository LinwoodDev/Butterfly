...
| Property | Default                                  | 說明                                                                                                      |
| -------- | ---------------------------------------- | ------------------------------------------------------------------------------------------------------- |
| 顏色       | Black for strokes; transparent for fills | Color of the painted region.                                                            |
| 不透明      | 255 for strokes; 0 for fills             | Opacity from transparent (`0`) to opaque (`255`). |
...
| 不透明         | 255 for a new opaque stroke; 0 when converted from a transparent fill | Changes the opacity of all stops, from `0` to `255`.                                                            |
...
| Property | Default  | 說明                                          |
| -------- | -------- | ------------------------------------------- |
| 開始       | `(0, 0)` | Start of the gradient axis. |
...
| Property     | Default              | 說明                                                                            |
| ------------ | -------------------- | ----------------------------------------------------------------------------- |
| 中            | `(0.5, 0.5)`         | Center of the outer circle, relative to the element bounds.   |
...
| Property | Default | 說明                                                                                             |
| -------- | ------- | ---------------------------------------------------------------------------------------------- |
| 來源       | 無       | Image or SVG to use in the painted region.                                     |
| Tint     | White   | Color filter. White at full alpha preserves the source colors. |
| 不透明      | 255     | Opacity of the tinted source, from `0` to `255`.                               |
| 縮放       | `0.25`  | Size of the source pattern in the painted region.                              |
| Blur     | `0`     | Softens the painted edge.                                                      |
