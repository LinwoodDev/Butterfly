...
|      不透明 |             255             | The opacity of the grid lines.                                                         |
|     筆劃寬度 |              1              | The width of the grid lines.                                                           |
|     隨應縮放 |            false            | Changes the grid cell spacing and snapping behavior relative to the zoom level.        |
