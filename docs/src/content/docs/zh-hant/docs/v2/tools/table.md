...
| 寬度       | 0                     | Fixed table width; `0` uses the default width based on the columns.                                                 |
...
| 填滿       | Transparent           | Table background color and alpha.                                                                                   |
| 隨應縮放     | Off                   | Changes table creation size based on the zoom level.                                                                |
