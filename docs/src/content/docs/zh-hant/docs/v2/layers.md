...
| Option | 說明                                                                                |
| -----: | --------------------------------------------------------------------------------- |
|   上提一層 | Renders the selection on top of the first element in front of it. |
|   下推一層 | Renders the selection under the first element behind it.          |
|   提至頂層 | Renders the selection in front of everything else.                |
|   推至底層 | Renders the selection behind everything else.                     |
