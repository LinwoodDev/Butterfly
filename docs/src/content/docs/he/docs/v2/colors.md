...
|     אלפא | 255 / 0 | The opacity of the color                                        |
...
|              אלפא |        255 / 0       | The opacity of the color. How transparent the image should be |
|              Blur |           0          | How much the color transition to the background will be blurred               |
| קנה מידה של תמונה | 0.25 | How big the image should be                                                   |
...
|    Property |                     Default                     | תיאור                                                                                                                                              |
| ----------: | :---------------------------------------------: | :------------------------------------------------------------------------------------------------------------------------------------------------- |
|        התחל |             (0,0)            | Starting position of the linear-gradient axis; percentually relative to the top left corner                                                        |
...
|      Property |                            Default                           | תיאור                                                                                                                                                                        |
| ------------: | :----------------------------------------------------------: | :--------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
|          מרכז | (0.5,0.5) | Position of the boundary circle's geometric middle at 100% offset, relative to the element bounds.                                                           |
