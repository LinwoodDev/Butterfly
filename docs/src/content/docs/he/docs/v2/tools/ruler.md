...
| -------- | -------- | ------------------------------------------------------------------------- |
| גודל     | 100      | The ruler's height.                                       |
| רקע      | לא הוגדר | Fill color of the ruler; uses the theme when unset.       |
| חזית     | לא הוגדר | Color of the ruler marks; chosen for contrast when unset. |
| זווית    | 0°       | Runtime angle control shown while the ruler is active.    |
