...
| ---------: | :-------------------------: | :----------------------------------------------------------------------------------------------------- |
|       גודל | (20, 20) | The size of the grid cells on the x and y axis.                                        |
|     Offset |  (0, 0)  | The offset of the grid on the x and y axis.                                            |
|      Color |            Black            | The color of the grid.                                                                 |
|       אלפא |             255             | The opacity of the grid lines.                                                         |
|    עובי קו |              1              | The width of the grid lines.                                                           |
|   תלוי זום |            false            | Changes the grid cell spacing and snapping behavior relative to the zoom level.        |
| תלוי מיקום |            false            | Makes the grid depend on the canvas position instead of staying fixed on the viewport. |
