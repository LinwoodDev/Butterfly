...
|          צורה |   מלבן  | The shape that will be drawn                                                                                                                                                                      |
...
| Property |   Default   | תיאור                                            |
| -------: | :---------: | :----------------------------------------------- |
|    מילוי | Transparent | The color that will be drawn inside the triangle |

#### עיגול

| Property |   Default   | תיאור                                          |
| -------: | :---------: | :--------------------------------------------- |
|    מילוי | Transparent | The color that will be drawn inside the circle |
