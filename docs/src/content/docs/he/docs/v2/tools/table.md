...
| רוחב     | 0                     | Fixed table width; `0` uses the default width based on the columns.                                                 |
| גובה     | 0                     | Fixed table height; `0` uses the default height based on the rows.                                                  |
...
| מילוי    | Transparent           | Table background color and alpha.                                                                                   |
| תלוי זום | Off                   | Changes table creation size based on the zoom level.                                                                |
