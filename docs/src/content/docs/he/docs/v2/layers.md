...
|    Option | תיאור                                                                             |
| --------: | --------------------------------------------------------------------------------- |
| הבא קדימה | Renders the selection on top of the first element in front of it. |
| שלח אחורה | Renders the selection under the first element behind it.          |
| הבא לקדמה | Renders the selection in front of everything else.                |
| העבר לרקע | Renders the selection behind everything else.                     |
