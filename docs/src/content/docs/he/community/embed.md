...
| ------------- | -------------- | ------ | -------------------------- |
| enabled       | רגיל           | כן     | When enabled by the user   |
| layoutOnly    | רגיל           | כן     | אף פעם                     |
| startInLayout | Full screen    | כן     | אף פעם                     |
| forced        | Full screen    | לא     | אף פעם                     |
| disabled      | רגיל           | לא     | אף פעם                     |
