...
| ------------- | -------------- | ------ | -------------------------- |
| enabled       | Normalno       | Da     | When enabled by the user   |
| layoutOnly    | Normalno       | Da     | Nikada                     |
| startInLayout | Full screen    | Da     | Nikada                     |
| forced        | Full screen    | Ne     | Nikada                     |
| disabled      | Normalno       | Ne     | Nikada                     |
