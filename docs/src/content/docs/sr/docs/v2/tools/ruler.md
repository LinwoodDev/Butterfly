...
| ------------ | ---------------- | ------------------------------------------------------------------------- |
| Veličina     | 100              | The ruler's height.                                       |
| Pozadina     | Nije postavljeno | Fill color of the ruler; uses the theme when unset.       |
| Prednji plan | Nije postavljeno | Color of the ruler marks; chosen for contrast when unset. |
| Ugao         | 0°               | Runtime angle control shown while the ruler is active.    |
