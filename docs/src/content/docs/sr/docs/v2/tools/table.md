...
| Širina          | 0                     | Fixed table width; `0` uses the default width based on the columns.                                                 |
| Visina          | 0                     | Fixed table height; `0` uses the default height based on the rows.                                                  |
...
| Popuna          | Transparent           | Table background color and alpha.                                                                                   |
| Zavisno od zuma | Off                   | Changes table creation size based on the zoom level.                                                                |
