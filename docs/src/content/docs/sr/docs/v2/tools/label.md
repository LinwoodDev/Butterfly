...
|    Prednji plan |  Black  | The text color.                                                        |
|           Skala |    2    | The scale of the label.                                                |
| Zavisno od zuma |  false  | Changes the label size based on the zoom level.                        |
|     Style sheet |  Ništa  | The style sheet used for the label.                                    |
