...
|        Blur |           0          | How much the color transition to the background will be blurred               |
| Skala slike | 0.25 | How big the image should be                                                   |
...
|    Property |                     Default                     | Opis                                                                                                                                               |
| ----------: | :---------------------------------------------: | :------------------------------------------------------------------------------------------------------------------------------------------------- |
|     Početak |             (0,0)            | Starting position of the linear-gradient axis; percentually relative to the top left corner                                                        |
...
|      Property |                            Default                           | Opis                                                                                                                                                                         |
| ------------: | :----------------------------------------------------------: | :--------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
|        Centar | (0.5,0.5) | Position of the boundary circle's geometric middle at 100% offset, relative to the element bounds.                                                           |
