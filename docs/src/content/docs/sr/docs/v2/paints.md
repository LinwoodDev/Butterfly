...
| Property | Default  | Opis                                        |
| -------- | -------- | ------------------------------------------- |
| Početak  | `(0, 0)` | Start of the gradient axis. |
...
| Property     | Default              | Opis                                                                          |
| ------------ | -------------------- | ----------------------------------------------------------------------------- |
| Centar       | `(0.5, 0.5)`         | Center of the outer circle, relative to the element bounds.   |
...
| Property | Default | Opis                                                                                           |
| -------- | ------- | ---------------------------------------------------------------------------------------------- |
| Izvor    | Ništa   | Image or SVG to use in the painted region.                                     |
