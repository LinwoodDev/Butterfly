...
|        Option | Opis                                                                              |
| ------------: | --------------------------------------------------------------------------------- |
| Pomeri napred | Renders the selection on top of the first element in front of it. |
|  Pomeri nazad | Renders the selection under the first element behind it.          |
| Dovedi napred | Renders the selection in front of everything else.                |
| Pošalji nazad | Renders the selection behind everything else.                     |
