...
| ------------- | -------------- | ------ | -------------------------- |
| enabled       | Thường         | Có     | When enabled by the user   |
| layoutOnly    | Thường         | Có     | Không bao giờ              |
| startInLayout | Toàn màn hình  | Có     | Không bao giờ              |
| forced        | Toàn màn hình  | Không  | Không bao giờ              |
| disabled      | Thường         | Không  | Không bao giờ              |
