...
|         Option | Mô tả                                                                             |
| -------------: | --------------------------------------------------------------------------------- |
|  Đưa lên trước | Renders the selection on top of the first element in front of it. |
|  Đưa xuống sau | Renders the selection under the first element behind it.          |
|   Đưa lên trên | Renders the selection in front of everything else.                |
| Đưa xuống dưới | Renders the selection behind everything else.                     |
