...
| Chiều rộng          | 0                     | Fixed table width; `0` uses the default width based on the columns.                                                 |
| Chiều cao           | 0                     | Fixed table height; `0` uses the default height based on the rows.                                                  |
...
| Tô                  | Transparent           | Table background color and alpha.                                                                                   |
| Phụ thuộc thu phóng | Off                   | Changes table creation size based on the zoom level.                                                                |
