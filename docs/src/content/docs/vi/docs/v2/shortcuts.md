...
| ----------------: | :-----: | :---------------------------------------------------------------------------------------- |
| Ẩn con trỏ khi vẽ |   true  | Hides the mouse pointer while you draw, so it does not cover your stroke. |
...
|             Property | Default | Mô tả                                                                                                       |
| -------------------: | :-----: | :---------------------------------------------------------------------------------------------------------- |
|       Cử chỉ đầu vào |   true  | Lets you move and zoom the canvas with touch gestures, even while drawing tool is selected. |
| Di chuyển khi cử chỉ |   true  | Lets multi-touch gestures move the canvas instead of interacting with note content.         |
...
|                        Property |              Values              | Mô tả                                                                                                                            |
| ------------------------------: | :------------------------------: | :------------------------------------------------------------------------------------------------------------------------------- |
|       Chỉ nhận đầu vào bằng bút | Automatic, Always on, Always off | Prevents accidental marks from your hand or mouse when only pen input can draw.                                  |
| Chỉ hiển thị bút khi chuyển đổi |            true, false           | Shows a quick pen-only switch in the editor after Butterfly detects a pen.                                       |
|                   Bỏ qua áp lực |       Never, First, Always       | Controls whether a pen pressure changes the stroke and works around inaccurate pressure readings from some pens. |
