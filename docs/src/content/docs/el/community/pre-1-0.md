...
Αυτές οι εκδόσεις δεν υποστηρίζονται πλέον.
Νέες εκδόσεις είναι διαθέσιμες σε [versions](/community/versions).
...
| 1,0.0-άλφα.0                 | :x: | [Docs](https://butterfly.linwood.dev/docs/1.0.0-alpha.0/intro) [Release](https://github.com/LinwoodDev/Butterfly/releases/tag/v1.0.0-alpha.0) |
