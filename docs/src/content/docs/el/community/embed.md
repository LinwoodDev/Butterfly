...
| Τιμή          | Initial layout | Toggle | Browser/system full screen |
| ------------- | -------------- | ------ | -------------------------- |
| enabled       | Κανονικό       | Ναι    | When enabled by the user   |
| layoutOnly    | Κανονικό       | Ναι    | Ποτέ                       |
| startInLayout | Πλήρης οθόνη   | Ναι    | Ποτέ                       |
| forced        | Πλήρης οθόνη   | Όχι    | Ποτέ                       |
| disabled      | Κανονικό       | Όχι    | Ποτέ                       |
...
| Parameter          | Τύπος     | Προεπιλογή              | Περιγραφή                                                                                   |
| ------------------ | --------- | ----------------------- | ------------------------------------------------------------------------------------------- |
