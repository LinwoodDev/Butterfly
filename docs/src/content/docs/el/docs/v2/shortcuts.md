...
| -----------------------------: | :--------: | :-------------------------------------------------------------------------------------------------------------------- |
| Απόκρυψη δρομέα κατά το σχέδιο |    true    | Κρύβει το δείκτη του ποντικιού ενώ σχεδιάζετε, έτσι ώστε να μην καλύπτει το εγκεφαλικό επεισόδιο σας. |
...
| Μετακίνηση στη χειρονομία |    true    | Αφήνει τις χειρονομίες πολλαπλών αφής να μετακινήσετε τον καμβά αντί να αλληλεπιδράσετε με το περιεχόμενο σημειώσεων. |
...
| ----------------------------: | :------------------------------: | :------------------------------------------------------------------------------------------------------------------------------- |
|            Είσοδος μόνο πένας | Automatic, Always on, Always off | Prevents accidental marks from your hand or mouse when only pen input can draw.                                  |
| Εμφάνιση εναλλαγής μόνο πένας |            true, false           | Εμφανίζει έναν γρήγορο διακόπτη στυλό μόνο στον επεξεργαστή αφού η πεταλούδα ανιχνεύσει μια πένα.                |
|              Παράβλεψη πίεσης |       Never, First, Always       | Controls whether a pen pressure changes the stroke and works around inaccurate pressure readings from some pens. |
