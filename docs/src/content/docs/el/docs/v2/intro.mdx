...
<Tabs syncKey="platform">
  <TabItem label="Επιφάνεια Εργασίας">
  ...
  <TabItem label="Κινητό">
    ...
    At the top of the screen you will see the release name and a link to the release notes and documentation.

    Below those, you can find Quickstart with your favorite templates, or the built-in Light and Dark templates when you have not chosen favorites. Below the templates, you will see your recent files.
...
<Tabs syncKey="platform">
  <TabItem label="Επιφάνεια Εργασίας">
    ...
    * The <MagnifyingGlass className="inline-icon" /> Search button, which allows you to search for elements within the note.
...
<Tabs syncKey="platform">
  <TabItem label="Επιφάνεια Εργασίας">
    ...
    To reorder the tools on your toolbar, first select a tool and then click-and-drag it to a new position. Some input methods have shortcuts to quickly switch to tools based on their position on the toolbar, which can be [configured](../shortcuts#tool-activators).
  ...
  <TabItem label="Κινητό">
    ...
    To reorder the tools on your toolbar, first select a tool and then long-tap and drag it to a new position. Some input methods have shortcuts to quickly switch to tools based on their position on the toolbar, which can be [configured](../shortcuts#tool-activators).
