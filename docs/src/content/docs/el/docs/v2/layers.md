...
Εδώ μπορείτε να δείτε όλα τα στρώματα του έργου. To create a new layer, use the Create button. To
...
|       Επιλογή | Περιγραφή                                                                         |
| ------------: | --------------------------------------------------------------------------------- |
| Φέρτε μπροστά | Renders the selection on top of the first element in front of it. |
| Αποστολή πίσω | Renders the selection under the first element behind it.          |
| Φέρτε μπροστά | Renders the selection in front of everything else.                |
| Αποστολή πίσω | Renders the selection behind everything else.                     |
