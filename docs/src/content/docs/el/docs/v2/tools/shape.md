...
|          Περιορισμός |                    ψευδές                    | Applies the shape's size or aspect ratio constraint while drawing.                                                                                                                              |
...
|                Χρώμα |    Solid Color (Black)    | [Paint](../../paints/) used for the shape outline.                                                                                                                                              |
...
|              Γέμισμα | Solid Color (Transparent) | [Paint](../../paints/) used inside the shape. Not available for Line shapes.                                                                                                    |
