...
| ------------------- | --------------------- | ----------------------------------------------------------------------------------------------------------------------------------- |
| Γραμμές             | 3                     | Initial number of rows.                                                                                             |
| Στήλες              | 3                     | Initial number of columns.                                                                                          |
| Width               | 0                     | Fixed table width; `0` uses the default width based on the columns.                                                 |
| Ύψος                | 0                     | Fixed table height; `0` uses the default height based on the rows.                                                  |
...
| Γέμισμα             | Διαφανές              | Table background color and alpha.                                                                                   |
| Εξαρτώμενο από ζουμ | Ανενεργό              | Changes table creation size based on the zoom level.                                                                |
