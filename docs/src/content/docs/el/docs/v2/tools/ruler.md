...
| --------- | ---------------- | ------------------------------------------------------------------------- |
| Μέγεθος   | 100              | The ruler's height.                                       |
| Φόντο     | Δεν έχει οριστεί | Fill color of the ruler; uses the theme when unset.       |
| Προσκήνιο | Δεν έχει οριστεί | Color of the ruler marks; chosen for contrast when unset. |
| Γωνία     | 0°               | Runtime angle control shown while the ruler is active.    |
