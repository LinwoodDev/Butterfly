...
Click on [this link](https://play.google.com/apps/testing/dev.linwood.butterfly) to register for the [nightly](/nightly) version of the app. Παρακαλώ σημειώστε ότι αυτή η έκδοση μπορεί να έχει σφάλματα. Η έκδοση play store θα ενημερώνεται αυτόματα όταν κυκλοφορήσει μια νέα νυχτερινή έκδοση.
