...
Aqui você pode ver todas as camadas no projeto. To create a new layer, use the Create button. To
...
| -----------------: | --------------------------------------------------------------------------------- |
| Trazer para frente | Renders the selection on top of the first element in front of it. |
|   Enviar para trás | Renders the selection under the first element behind it.          |
| Trazer para frente | Renders the selection in front of everything else.                |
|   Enviar para trás | Renders the selection behind everything else.                     |
