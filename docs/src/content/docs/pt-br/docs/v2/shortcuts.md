...
| -------------------------------: | :----: | :------------------------------------------------------------------------------------------------- |
| Ocultar cursor durante o desenho |  true  | Oculta o ponteiro do mouse enquanto você desenha, então ele não cobre seu traçado. |
...
|       Propriedade | Padrão | Descrição                                                                                                       |
| ----------------: | :----: | :-------------------------------------------------------------------------------------------------------------- |
| Gestos de entrada |  true  | Lets you move and zoom the canvas with touch gestures, even while drawing tool is selected.     |
|  Mover para gesto |  true  | Permite que os gestos de vários toque movam a tela em vez de interagir com o conteúdo de notas. |
...
| -------------------------: | :------------------------------: | :------------------------------------------------------------------------------------------------------------------------------- |
| Entrada somente por caneta | Automatic, Always on, Always off | Prevents accidental marks from your hand or mouse when only pen input can draw.                                  |
|   Mostrar somente a caneta |            true, false           | Exibe uma chave de caneta rápida no editor após a Butterfly detectar uma caneta.                                 |
|            Ignorar pressão |       Never, First, Always       | Controls whether a pen pressure changes the stroke and works around inaccurate pressure readings from some pens. |
