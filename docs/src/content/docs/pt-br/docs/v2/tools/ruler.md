...
| -------------- | ------------ | ------------------------------------------------------------------------- |
| Tamanho        | 100          | The ruler's height.                                       |
| Plano de fundo | Não definido | Fill color of the ruler; uses the theme when unset.       |
| Primeiro plano | Não definido | Color of the ruler marks; chosen for contrast when unset. |
| Ângulo         | 0°           | Runtime angle control shown while the ruler is active.    |
