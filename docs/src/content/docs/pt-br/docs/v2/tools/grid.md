...
|    Espessura do traço |              1              | The width of the grid lines.                                                           |
|    Dependendo do zoom |            Falso            | Changes the grid cell spacing and snapping behavior relative to the zoom level.        |
