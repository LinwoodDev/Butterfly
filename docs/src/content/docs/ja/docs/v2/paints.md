...
| ---------- | ----------------------------------------------------------------------- | ------------------------------------------------------------------ |
| 単色         | Uses one color throughout the stroke or fill.           | Color, alpha, blur.                                |
| Gradient   | Blends between color stops.                             | Linear or radial layout, color stops, alpha, blur. |
| 画像         | Repeats an imported raster image in the painted region. | Source image, tint, alpha, scale, blur.            |
