...
| 属性           | デフォルト | 説明                                                                        |
| ------------ | ----- | ------------------------------------------------------------------------- |
| サイズ          | 100   | The ruler's height.                                       |
| 背景           | 未設定   | Fill color of the ruler; uses the theme when unset.       |
| フォアグラウンド（前面） | 未設定   | Color of the ruler marks; chosen for contrast when unset. |
| 角度           | 0°    | Runtime angle control shown while the ruler is active.    |
