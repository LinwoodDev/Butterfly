...
| 属性       | デフォルト                 | 説明                                                                                                                                  |
| -------- | --------------------- | ----------------------------------------------------------------------------------------------------------------------------------- |
| 行        | 3                     | Initial number of rows.                                                                                             |
| 列        | 3                     | Initial number of columns.                                                                                          |
| Width    | 0                     | Fixed table width; `0` uses the default width based on the columns.                                                 |
| 高さ       | 0                     | Fixed table height; `0` uses the default height based on the rows.                                                  |
...
| 塗りつぶし    | 透明度                   | Table background color and alpha.                                                                                   |
| ズームに依存する | オフ                    | Changes table creation size based on the zoom level.                                                                |
