...
|            制約 |                     false                    | Applies the shape's size or aspect ratio constraint while drawing.                           |
...
|             色 |    Solid Color (Black)    | [Paint](../../paints/) used for the shape outline.                                           |
...
|         塗りつぶし | Solid Color (Transparent) | [Paint](../../paints/) used inside the shape. Not available for Line shapes. |
