...
ここでは、プロジェクト内のすべてのレイヤーを見ることができます。 To create a new layer, use the Create button. To
...
| Option | 説明                                                                                |
| -----: | --------------------------------------------------------------------------------- |
|  前方へ移動 | Renders the selection on top of the first element in front of it. |
|  後方に送る | Renders the selection under the first element behind it.          |
|  前面へ移動 | Renders the selection in front of everything else.                |
|  背面へ送る | Renders the selection behind everything else.                     |
