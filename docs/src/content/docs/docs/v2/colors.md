...
section will cover the different modes for both the **color** and the **fill** properties with gradients or images. See [Further customization](#further-customization).
