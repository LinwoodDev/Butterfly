...
<Tabs syncKey="platform">
  ...
  To add more tools to the toolbar, click the <Plus className="inline-icon"/> Plus button.
  
  To reorder the tools on your toolbar, first select a tool and then click-and-drag it to a new position.
 ...
 <TabItem label="Mobile">
  ...
  #### Customizing the Toolbar
  To add more tools to the toolbar, tap the <Plus className="inline-icon"/> Plus button.

  To reorder the tools on your toolbar, first select a tool and then long-tap and drag it to a new position.
