...
<Tabs syncKey="platform">
    ...
    You can o the context menu by either right-clicking an area or using the <Monitor className="inline-icon"/> Area section of the Navigator on the left side of the screen.
    </TabItem>
