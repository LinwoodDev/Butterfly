...
| Property | Default | Description |
| --- | --- | --- |
| Center | `(0.5, 0.5)` | Center of the outer circle, relative to the element bounds. |
...
| Property | Default | Description |
| --- | --- | --- |
| Source | None | Image or SVG to use in the painted region. |
...
| Scale | `0.25` | Size of the source pattern in the painted region. |
| Blur | `0` | Softens the painted edge. |
