...
| --- | --- | --- |
| Size | 100 | The ruler's height. |
| Background | Not set | Fill color of the ruler; uses the theme when unset. |
| Foreground | Not set | Color of the ruler marks; chosen for contrast when unset. |
