...
| Height | 0 | Fixed table height; `0` uses the default height based on the rows. |
...
| Fill | Transparent | Table background color and alpha. |
| Zoom dependent | Off | Changes table creation size based on the zoom level. |
