...
Click on [this link](https://play.google.com/apps/testing/dev.linwood.butterfly) to register for the [nightly](/nightly) version of the app. 請注意，此版本可能會有錯誤。 當新的夜間版發布時，Play 商店裏的版本會自動更新。
