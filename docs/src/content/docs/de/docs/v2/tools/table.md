...
| ------------ | --------------------- | ----------------------------------------------------------------------------------------------------------------------------------- |
| Zeilen       | 3                     | Initial number of rows.                                                                                             |
| Spalten      | 3                     | Initial number of columns.                                                                                          |
| Breite       | 0                     | Fixed table width; `0` uses the default width based on the columns.                                                 |
| Höhe         | 0                     | Fixed table height; `0` uses the default height based on the rows.                                                  |
...
| Füllen       | Transparent           | Table background color and alpha.                                                                                   |
| Zoomabhängig | Aus                   | Changes table creation size based on the zoom level.                                                                |
