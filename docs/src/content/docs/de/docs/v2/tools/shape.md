...
|    Einschränkung |                    falsch                    | Applies the shape's size or aspect ratio constraint while drawing.                                                                                                                          |
...
|            Farbe |    Solid Color (Black)    | [Paint](../../paints/) used for the shape outline.                                                                                                                                          |
...
|           Füllen | Solid Color (Transparent) | [Paint](../../paints/) used inside the shape. Not available for Line shapes.                                                                                                |
