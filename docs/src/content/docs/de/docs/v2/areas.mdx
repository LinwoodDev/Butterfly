...
Flächen sind eine Möglichkeit, die Größe der Leinwand zu beschränken. You can create areas by using the [area tool](tools/area). Wenn Sie auf den Hintergrund klicken, können Sie den Bereichslisten-Dialog über das Kontextmenü öffnen.
