...
Click on [this link](https://play.google.com/apps/testing/dev.linwood.butterfly) to register for the [nightly](/community/nightly) version of the app. Bitte beachten Sie, dass diese Version Bugs haben kann. Die Play Store-Version wird automatisch aktualisiert, wenn eine neue nächtliche Version veröffentlicht wird.
