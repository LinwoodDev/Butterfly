...
Click on [this link](https://play.google.com/apps/testing/dev.linwood.butterfly) to register for the [nightly](/nightly) version of the app. Vær oppmerksom på at denne versjonen kan ha feil. Spillbutikkversjonen vil automatisk bli oppdatert når en ny nightly versjon blir lansert.
