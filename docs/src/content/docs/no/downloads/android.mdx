...
:::tip[What apk bør jeg bruke?]

**Universelt** burde fungere på alle enheter. Hvis du vil ha en mindre ape, bruk den som passer din enhets arkitektur.
...
Klikk på [denne linken](https://play.google.com/apps/testing/dev.linwood.butterfly) for å registrere deg for [nightly](/community/nightly) versjon av appen. Vær oppmerksom på at denne versjonen kan ha feil. Spillbutikkversjonen vil automatisk bli oppdatert når en ny nightly versjon blir lansert.
