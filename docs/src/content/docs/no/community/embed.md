...
| språk      | Streng (..., system, bruker) | user     | Language of the document. If system, the language will be detected from the browser. If user, the language will set to the users preference |
| fileName   | String                                                                                          |          | Display this file name in the embed title. It is visual only and does not change the document metadata                                                      |

### Full-screen modes

| Verdi         | Initial layout | Toggle | Browser/system full screen |
| ------------- | -------------- | ------ | -------------------------- |
| enabled       | Vanlig         | Ja     | When enabled by the user   |
| layoutOnly    | Vanlig         | Ja     | Aldri                      |
| startInLayout | Full skjerm    | Ja     | Aldri                      |
| forced        | Full skjerm    | Nei    | Aldri                      |
| disabled      | Vanlig         | Nei    | Aldri                      |
