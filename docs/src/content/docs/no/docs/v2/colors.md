...
| -------: | :------: | :-------------------------------------------------------------- |
|    Farge |   Svart  | The color of the property                                       |
...
|            Blur |           0          | How much the color transition to the background will be blurred               |
| Bilde skalering | 0.25 | How big the image should be                                                   |
...
|      Egenskap |                     Standard                    | Beskrivelse                                                                                                                                        |
| ------------: | :---------------------------------------------: | :------------------------------------------------------------------------------------------------------------------------------------------------- |
|        Begynn |             (0,0)            | Starting position of the linear-gradient axis; percentually relative to the top left corner                                                        |
|         Slutt |             (1,0)            | End position of the linear-gradient axis; percentually relative to the top left corner                                                             |
| Farge stopper | 2 Color stops (Black, White) | The offset of a Color stop percentually defines where along the gradient axis a color is placed. There are color and alpha options |

### Radial Gradient

|      Egenskap |                           Standard                           | Beskrivelse                                                                                                                                                                  |
| ------------: | :----------------------------------------------------------: | :--------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
|     Midtstilt | (0.5,0.5) | Position of the boundary circle's geometric middle at 100% offset, relative to the element bounds.                                                           |
...
| Farge stopper |        2 Color stops (Black, White)       | The offset of a Color stop percentually defines where between focal point and the boundary the color is placed. There are color and alpha options            |
