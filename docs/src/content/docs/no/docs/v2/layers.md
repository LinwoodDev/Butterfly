...
Her kan du se alle lagene i prosjektet. To create a new layer, use the Create button. To
...
| ------------------: | --------------------------------------------------------------------------------- |
|       Send fremover | Renders the selection on top of the first element in front of it. |
|        Send bakover | Renders the selection under the first element behind it.          |
| Plasser lengst frem | Renders the selection in front of everything else.                |
|    Send til tilbake | Renders the selection behind everything else.                     |
