...
|          Velg når kanter berører | The shape will be selected when the selected area intersects any edge.      |
| Velg ved berøring hvor som helst | The shape will be selected when any part of it is inside the selected area. |
