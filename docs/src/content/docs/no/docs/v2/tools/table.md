...
| Fyll          | Gjennomsiktig         | Table background color and alpha.                                                                                   |
| Zoom avhengig | Av                    | Changes table creation size based on the zoom level.                                                                |
