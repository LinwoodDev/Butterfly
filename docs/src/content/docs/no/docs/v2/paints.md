...
| -------- | ---------------------------------------- | ------------------------------------------------------------------------------------------------------- |
| Farge    | Black for strokes; transparent for fills | Color of the painted region.                                                            |
...
| Egenskap      | Standard                                                              | Beskrivelse                                                                                                                     |
| ------------- | --------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------- |
| Farge stopper | Black at `0`; white at `1`                                            | Each stop has an offset, color, and alpha value. The offset determines where the color appears. |
...
| Egenskap | Standard | Beskrivelse                                 |
| -------- | -------- | ------------------------------------------- |
| Begynn   | `(0, 0)` | Start of the gradient axis. |
| Slutt    | `(1, 0)` | End of the gradient axis.   |
...
| Egenskap     | Standard             | Beskrivelse                                                                   |
| ------------ | -------------------- | ----------------------------------------------------------------------------- |
| Midtstilt    | `(0.5, 0.5)`         | Center of the outer circle, relative to the element bounds.   |
| Radius       | `0.5`                | Radius of the outer circle.                                   |
| Fokuspunkt   | Off; uses the center | Enable to move the inner starting point away from the center. |
