...
Områder er en måte å begrense størrelsen på lerretet. You can create areas by using the [area tool](tools/area). Hvis du klikker på bakgrunnen, kan du åpne områdeliste dialogen ved hjelp av kontekstmenyen.
