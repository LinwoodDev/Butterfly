...
| ---------------------------: | :------: | :---------------------------------------------------------------------------------------- |
| Skjul markøren under tegning |   true   | Skjuler musepekeren mens du trekker, slik at den ikke dekker slaget ditt. |
...
| Flytt på bevegelse |   true   | Lar multi-touch bevegelser flytte lerretet i stedet for å samhandle med notatinnhold.       |
...
|              Egenskap |              Values              | Beskrivelse                                                                                                                      |
| --------------------: | :------------------------------: | :------------------------------------------------------------------------------------------------------------------------------- |
| Pennen er kun inndata | Automatic, Always on, Always off | Prevents accidental marks from your hand or mouse when only pen input can draw.                                  |
|          Vis kun penn |            true, false           | Viser en rask penn-bare bytt i editoren etter Butterfly oppdager en penn.                                        |
|         Ignorer trykk |       Never, First, Always       | Controls whether a pen pressure changes the stroke and works around inaccurate pressure readings from some pens. |
