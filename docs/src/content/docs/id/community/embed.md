...
| Option     | Jenis                                                                                         | Default | Deskripsi                                                                                                                                                                   |
| ---------- | --------------------------------------------------------------------------------------------- | ------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
...
| ------------- | -------------- | ------ | -------------------------- |
| enabled       | Biasa          | Ya     | When enabled by the user   |
| layoutOnly    | Biasa          | Ya     | Tidak pernah               |
| startInLayout | Full screen    | Ya     | Tidak pernah               |
| forced        | Full screen    | Tidak  | Tidak pernah               |
| disabled      | Biasa          | Tidak  | Tidak pernah               |
