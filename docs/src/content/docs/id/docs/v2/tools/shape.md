...
|              Batasan |                     false                    | Applies the shape's size or aspect ratio constraint while drawing.                                                                                                                |
...
|               Bentuk |                Persegi panjang               | The shape that will be drawn. Available shapes are Rectangle, Triangle, Circle and Line                                                                                           |
|         Radius sudut |                  0, 0, 0, 0                  | The radius of the corners when shape is Rectangle                                                                                                                                                 |
|                  Isi | Solid Color (Transparent) | [Paint](../../paints/) used inside the shape. Not available for Line shapes.                                                                                      |
