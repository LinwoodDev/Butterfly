...
| Lebar                | 0                     | Fixed table width; `0` uses the default width based on the columns.                                                 |
| Tinggi               | 0                     | Fixed table height; `0` uses the default height based on the rows.                                                  |
...
| Isi                  | Transparent           | Table background color and alpha.                                                                                   |
| Bergantung pada zoom | Mati                  | Changes table creation size based on the zoom level.                                                                |
