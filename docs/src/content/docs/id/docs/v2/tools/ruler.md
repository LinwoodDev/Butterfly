...
| -------------- | ------------ | ------------------------------------------------------------------------- |
| Ukuran         | 100          | The ruler's height.                                       |
| Latar belakang | Belum diatur | Fill color of the ruler; uses the theme when unset.       |
| Latar depan    | Belum diatur | Color of the ruler marks; chosen for contrast when unset. |
| Sudut          | 0°           | Runtime angle control shown while the ruler is active.    |
