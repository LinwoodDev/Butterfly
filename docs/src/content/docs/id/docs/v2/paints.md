...
| Property | Default  | Deskripsi                                   |
| -------- | -------- | ------------------------------------------- |
| Mulai    | `(0, 0)` | Start of the gradient axis. |
...
| Property     | Default              | Deskripsi                                                                     |
| ------------ | -------------------- | ----------------------------------------------------------------------------- |
| Tengah       | `(0.5, 0.5)`         | Center of the outer circle, relative to the element bounds.   |
...
| Property | Default   | Deskripsi                                                                                      |
| -------- | --------- | ---------------------------------------------------------------------------------------------- |
| Sumber   | Tidak ada | Image or SVG to use in the painted region.                                     |
