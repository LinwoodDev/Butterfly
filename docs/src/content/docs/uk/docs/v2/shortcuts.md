...
| -------------------------------: | :----: | :--------------------------------------------------------------------------------------- |
| Сховати курсор під час малювання |  true  | Приховує курсор миші, коли ви малюєте, тому він не покриває ваш інсульт. |
...
| Перемістити жест |  true  | Дозволяє жести мультисенсорного екрану перемістити полотно замість взаємодії з вмістом нотаток. |
...
| --------------------------------: | :------------------------------: | :------------------------------------------------------------------------------------------------------------------------------- |
|               Тільки введення Pen | Automatic, Always on, Always off | Prevents accidental marks from your hand or mouse when only pen input can draw.                                  |
| Показати тільки переключити ручку |            true, false           | Показує швидкий перемикач тільки в редакторі після того, як Butterfly виявить ручку.                             |
|                   Ігнорувати тиск |       Never, First, Always       | Controls whether a pen pressure changes the stroke and works around inaccurate pressure readings from some pens. |
