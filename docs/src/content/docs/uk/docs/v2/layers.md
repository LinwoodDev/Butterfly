...
Тут ви можете побачити усі шари проекту. To create a new layer, use the Create button. To
...
|                     Опція | Опис                                                                              |
| ------------------------: | --------------------------------------------------------------------------------- |
|          Поверніть вперед | Renders the selection on top of the first element in front of it. |
|          Відправити назад | Renders the selection under the first element behind it.          |
| Привести на передній план | Renders the selection in front of everything else.                |
| Відправити на задній план | Renders the selection behind everything else.                     |
