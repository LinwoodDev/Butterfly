...
| -------------- | --------- | ------------------------------------------------------------------------- |
| Розмір         | 100       | The ruler's height.                                       |
| Фон            | Не задано | Fill color of the ruler; uses the theme when unset.       |
| Активний режим | Не задано | Color of the ruler marks; chosen for contrast when unset. |
| Кут            | 0°        | Runtime angle control shown while the ruler is active.    |
