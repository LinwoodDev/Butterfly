...
|           Обмеження |                   хибність                   | Applies the shape's size or aspect ratio constraint while drawing.                                                                                                                                    |
...
|               Колір |    Solid Color (Black)    | [Paint](../../paints/) used for the shape outline.                                                                                                                                                    |
...
|       Заливка рядка | Solid Color (Transparent) | [Paint](../../paints/) used inside the shape. Not available for Line shapes.                                                                                                          |
