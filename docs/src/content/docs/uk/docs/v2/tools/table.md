...
| ------------------- | --------------------- | ----------------------------------------------------------------------------------------------------------------------------------- |
| Рядки               | 3                     | Initial number of rows.                                                                                             |
| Стовпці             | 3                     | Initial number of columns.                                                                                          |
| Width               | 0                     | Fixed table width; `0` uses the default width based on the columns.                                                 |
| Висота              | 0                     | Fixed table height; `0` uses the default height based on the rows.                                                  |
...
| Заливка рядка       | Прозорий              | Table background color and alpha.                                                                                   |
| Залежність масштабу | Вимкнено              | Changes table creation size based on the zoom level.                                                                |
