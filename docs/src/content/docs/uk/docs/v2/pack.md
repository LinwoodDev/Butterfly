...
A pack is a collection of components that can be used in the stamp tool. Ви можете створити власний пакет або імпортувати наявний. To do this, click the top-left corner and select "Packs".
