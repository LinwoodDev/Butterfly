...
:::tip[What apk повинен я використовувати?]

**Універсальний** повинен працювати на всіх пристроях. Якщо ви хочете менші Apk, використайте той, що відповідає архітектурі вашого пристрою.
...
Click on [this link](https://play.google.com/apps/testing/dev.linwood.butterfly) to register for the [nightly](/community/nightly) version of the app. Зверніть увагу, що ця версія може містити помилки. Версія Play Store буде автоматично оновлюватися при оновленні нової нічної версії.
