...
Ці версії більше не підтримуються.
...
| 1.0.0-альфа.0 | :x: | [Docs](https://butterfly.linwood.dev/docs/1.0.0-alpha.0/intro) [Release](https://github.com/LinwoodDev/Butterfly/releases/tag/v1.0.0-alpha.0) |
