...
Click on [this link](https://play.google.com/apps/testing/dev.linwood.butterfly) to register for the [nightly](/nightly) version of the app. Por favor, note que esta versão pode ter bugs. A versão do play store será atualizada automaticamente quando uma nova versão noturna for lançada.
