...
| 너비        | 0                     | Fixed table width; `0` uses the default width based on the columns.                                                 |
| 높이        | 0                     | Fixed table height; `0` uses the default height based on the rows.                                                  |
...
| 채우기       | Transparent           | Table background color and alpha.                                                                                   |
| 확대/축소에 따라 | Off                   | Changes table creation size based on the zoom level.                                                                |
