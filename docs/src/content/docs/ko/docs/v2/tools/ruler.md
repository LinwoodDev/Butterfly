...
| Property | Default | 설명                                                                        |
| -------- | ------- | ------------------------------------------------------------------------- |
| 크기       | 100     | The ruler's height.                                       |
| 배경       | 설정 안 됨  | Fill color of the ruler; uses the theme when unset.       |
| 전경       | 설정 안 됨  | Color of the ruler marks; chosen for contrast when unset. |
| 각도       | 0°      | Runtime angle control shown while the ruler is active.    |
