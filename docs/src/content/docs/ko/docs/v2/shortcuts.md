...
|      Property | Default | 설명                                                                                        |
| ------------: | :-----: | :---------------------------------------------------------------------------------------- |
| 그리는 동안 커서 숨기기 |   true  | Hides the mouse pointer while you draw, so it does not cover your stroke. |
...
| Property | Default | 설명                                                                                                          |
| -------: | :-----: | :---------------------------------------------------------------------------------------------------------- |
|   입력 제스처 |   true  | Lets you move and zoom the canvas with touch gestures, even while drawing tool is selected. |
|  제스처로 이동 |   true  | Lets multi-touch gestures move the canvas instead of interacting with note content.         |
...
|             Property |              Values              | 설명                                                                                                                               |
| -------------------: | :------------------------------: | :------------------------------------------------------------------------------------------------------------------------------- |
|              펜 전용 입력 | Automatic, Always on, Always off | Prevents accidental marks from your hand or mouse when only pen input can draw.                                  |
