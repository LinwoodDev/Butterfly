...
| ---------------------------------: | :-----: | :---------------------------------------------------------------------------------------- |
| Rajzolás közben a kurzor elrejtése |   true  | Hides the mouse pointer while you draw, so it does not cover your stroke. |
...
|            Property | Default | Leírás                                                                                                      |
| ------------------: | :-----: | :---------------------------------------------------------------------------------------------------------- |
|  Beviteli gesztusok |   true  | Lets you move and zoom the canvas with touch gestures, even while drawing tool is selected. |
| Mozgatás gesztussal |   true  | Lets multi-touch gestures move the canvas instead of interacting with note content.         |
...
|               Property |              Values              | Leírás                                                                                                                           |
| ---------------------: | :------------------------------: | :------------------------------------------------------------------------------------------------------------------------------- |
| Tollal történő bevitel | Automatic, Always on, Always off | Prevents accidental marks from your hand or mouse when only pen input can draw.                                  |
