...
|         Áttetszőség |             255             | The opacity of the grid lines.                                                         |
|           Vastagság |              1              | The width of the grid lines.                                                           |
| Függőleges nagyítás |            false            | Changes the grid cell spacing and snapping behavior relative to the zoom level.        |
