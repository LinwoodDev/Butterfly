...
| Szélesség           | 0                     | Fixed table width; `0` uses the default width based on the columns.                                                 |
| Magasság            | 0                     | Fixed table height; `0` uses the default height based on the rows.                                                  |
...
| Kitöltés            | Transparent           | Table background color and alpha.                                                                                   |
| Függőleges nagyítás | Off                   | Changes table creation size based on the zoom level.                                                                |
