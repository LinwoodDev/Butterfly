...
| -------- | --------------- | ------------------------------------------------------------------------- |
| Méret    | 100             | The ruler's height.                                       |
| Háttér   | Nincs beállítva | Fill color of the ruler; uses the theme when unset.       |
| Előtér   | Nincs beállítva | Color of the ruler marks; chosen for contrast when unset. |
| Szög     | 0°              | Runtime angle control shown while the ruler is active.    |
