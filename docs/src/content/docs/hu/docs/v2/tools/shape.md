...
|          Korlátozás |                     false                    | Applies the shape's size or aspect ratio constraint while drawing.                                                                                                                |
...
|                Szín |    Solid Color (Black)    | [Paint](../../paints/) used for the shape outline.                                                                                                                                |
|               Forma |                   Téglalap                   | The shape that will be drawn. Available shapes are Rectangle, Triangle, Circle and Line                                                                                           |
|        Sarok sugara |                  0, 0, 0, 0                  | The radius of the corners when shape is Rectangle                                                                                                                                                 |
|            Kitöltés | Solid Color (Transparent) | [Paint](../../paints/) used inside the shape. Not available for Line shapes.                                                                                      |
