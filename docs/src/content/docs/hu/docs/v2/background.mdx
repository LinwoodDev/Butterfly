...
These background layer types allow you to upload an image and use it as background for the page. Images will be tiled on the canvas, and you can configure the scale of the image to make the tiles larger or smaller. To place an image as a movable canvas element instead, see [Importing](../importing/).
