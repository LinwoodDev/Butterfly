...
|          Option | Leírás                                                                            |
| --------------: | --------------------------------------------------------------------------------- |
|   Előrébb hozás | Renders the selection on top of the first element in front of it. |
|   Hátrébb hozás | Renders the selection under the first element behind it.          |
|  Előtérbe hozás | Renders the selection in front of everything else.                |
| Háttérbe küldés | Renders the selection behind everything else.                     |
