...
| ------------- | -------------- | ------ | -------------------------- |
| enabled       | Normál         | Igen   | When enabled by the user   |
| layoutOnly    | Normál         | Igen   | Soha                       |
| startInLayout | Full screen    | Igen   | Soha                       |
| forced        | Full screen    | Nem    | Soha                       |
| disabled      | Normál         | Nem    | Soha                       |
...
| Parameter          | Típus     | Default                 | Leírás                                                                                      |
| ------------------ | --------- | ----------------------- | ------------------------------------------------------------------------------------------- |
