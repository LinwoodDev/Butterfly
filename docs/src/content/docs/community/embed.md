...
| ------------- | -------------- | ------ | -------------------------- |
| enabled       | Normal         | Yes    | When enabled by the user   |
| layoutOnly    | Normal         | Yes    | Never                      |
| startInLayout | Full screen    | Yes    | Never                      |
| forced        | Full screen    | No     | Never                      |
| disabled      | Normal         | No     | Never                      |
