...
Hier kunt u alle lagen in het project zien. To create a new layer, use the Create button. To
...
|                 Optie | Beschrijving                                                                      |
| --------------------: | --------------------------------------------------------------------------------- |
|      Breng naar voren | Renders the selection on top of the first element in front of it. |
|       Stuur achteruit | Renders the selection under the first element behind it.          |
|    Naar voren brengen | Renders the selection in front of everything else.                |
| Stuur naar achterkant | Renders the selection behind everything else.                     |
