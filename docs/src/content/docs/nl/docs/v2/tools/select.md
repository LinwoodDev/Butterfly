...
| Selecteer bij het aanraken van randen | The shape will be selected when the selected area intersects any edge.      |
|         Selecteer bij aanraken overal | The shape will be selected when any part of it is inside the selected area. |
