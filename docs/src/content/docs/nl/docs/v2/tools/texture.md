...
|              Width |     0     | De vaste breedte van het gebied. If set to `0`, the width will be calculated automatically.                                                                                        |
|              Højde |     0     | De vaste hoogte van het gebied. If set to `0`, the height will be calculated automatically.                                                                                        |
|  Aspect verhouding |     0     | De verhouding van het vaste aspect van het gebied. If set to `0`, the aspect ratio will be calculated automatically. An aspect ratio is defined as width / height. |
