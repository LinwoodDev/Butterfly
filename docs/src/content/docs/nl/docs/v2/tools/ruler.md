...
| ----------- | -------------- | ------------------------------------------------------------------------- |
| Grootte     | 100            | The ruler's height.                                       |
| Achtergrond | Niet ingesteld | Fill color of the ruler; uses the theme when unset.       |
| Voorgrond   | Niet ingesteld | Color of the ruler marks; chosen for contrast when unset. |
| Hoek        | 0°             | Runtime angle control shown while the ruler is active.    |
