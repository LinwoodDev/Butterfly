...
| ------------------ | --------------------- | ----------------------------------------------------------------------------------------------------------------------------------- |
| Rijen              | 3                     | Initial number of rows.                                                                                             |
| Kolommen           | 3                     | Initial number of columns.                                                                                          |
| Width              | 0                     | Fixed table width; `0` uses the default width based on the columns.                                                 |
| Højde              | 0                     | Fixed table height; `0` uses the default height based on the rows.                                                  |
...
| Invullen           | Transparent           | Table background color and alpha.                                                                                   |
| Afhankelijk zoomen | UIT                   | Changes table creation size based on the zoom level.                                                                |
