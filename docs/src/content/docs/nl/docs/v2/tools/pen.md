...
|    Combineer paden |                                 Onjuist                                | This will merge all strokes it touches into one path                                                                                    |
...
|         Stroomlijn |                           0.3                          | How much the pen will follow the movement of the mouse.                                                                 |
|              Kleur |                 Solid Color (Black)                 | [Customization](../../colors/#further-customization) for the color of the stroke                                                        |
|           Invullen |              Solid Color (Transparent)              | [Customization](../../colors/#further-customization) for the color drawn inside the enclosed area                                       |