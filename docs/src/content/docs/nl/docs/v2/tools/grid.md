...
|        Transparantie |             255             | The opacity of the grid lines.                                                         |
|       Stroke breedte |              1              | The width of the grid lines.                                                           |
|   Afhankelijk zoomen |           Onjuist           | Changes the grid cell spacing and snapping behavior relative to the zoom level.        |
| Afhankelijke positie |           Onjuist           | Makes the grid depend on the canvas position instead of staying fixed on the viewport. |
