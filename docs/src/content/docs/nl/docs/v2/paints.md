...
| ------------- | ----------------------------------------------------------------------- | ------------------------------------------------------------------ |
| Effen kleur   | Uses one color throughout the stroke or fill.           | Color, alpha, blur.                                |
| Kleurovergang | Blends between color stops.                             | Linear or radial layout, color stops, alpha, blur. |
| Afbeelding    | Repeats an imported raster image in the painted region. | Source image, tint, alpha, scale, blur.            |
