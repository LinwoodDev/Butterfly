...
A pack is a collection of components that can be used in the stamp tool. U kunt uw eigen pakket maken of een bestaande importeren. To do this, click the top-left corner and select "Packs".
