...
| -----------------------------: | :-------: | :------------------------------------------------------------------------------------------- |
| Verberg cursor tijdens tekenen |    true   | Verbergt de muisaanwijzer terwijl je tekent, dus dekt deze niet je beroerte. |
...
| Verplaats naar gebaar |    true   | Laat multi-touch gebaren het canvas verplaatsen in plaats van interactie met notitie-inhoud. |
...
| ------------------------: | :------------------------------: | :------------------------------------------------------------------------------------------------------------------------------- |
|         Alleen invoer pen | Automatic, Always on, Always off | Prevents accidental marks from your hand or mouse when only pen input can draw.                                  |
| Toon alleen penschakelaar |            true, false           | Toont een snelle schakelaar in de editor nadat Butterfly een pen detecteert.                                     |
|               Negeer druk |       Never, First, Always       | Controls whether a pen pressure changes the stroke and works around inaccurate pressure readings from some pens. |
