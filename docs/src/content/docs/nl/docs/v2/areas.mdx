...
Gebieden zijn een manier om de grootte van het doek te beperken. You can create areas by using the [area tool](../tools/area). Als u op de achtergrond klikt, kunt u het gebiedenlijst venster openen via het contextmenu.
