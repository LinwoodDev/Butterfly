...
Click on [this link](https://play.google.com/apps/testing/dev.linwood.butterfly) to register for the [nightly](/nightly) version of the app. Houd er rekening mee dat deze versie fouten kan hebben. De Play Store versie zal automatisch worden bijgewerkt wanneer een nieuwe nightly versie wordt vrijgegeven.
