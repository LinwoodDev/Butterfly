...
<CardGrid stagger>
  <Card title="Plateforme croisée" icon="laptop">
  ...
  <Card title="Choisissez où vos données sont stockées" icon="open-book">
...
<LinkCard title="Download today" href="/téléchargements/" />
