...
| -----------------------------------: | :--------: | :------------------------------------------------------------------------------------------------------------ |
| Masquer le curseur pendant le dessin |    true    | Masque le pointeur de la souris pendant que vous dessinez, donc il ne couvre pas votre tracé. |
...
| Geste de déplacement |    true    | Permet aux gestes tactiles de déplacer la toile au lieu d'interagir avec le contenu de la note. |
...
| --------------------------------------: | :------------------------------: | :------------------------------------------------------------------------------------------------------------------------------- |
|            Seules les entrées du stylet | Automatic, Always on, Always off | Prevents accidental marks from your hand or mouse when only pen input can draw.                                  |
| Afficher uniquement le bouton du stylet |            true, false           | Affiche un changement rapide de stylo seulement dans l'éditeur après que Butterfly ait détecté un stylo.         |
|                     Ignorer la pression |       Never, First, Always       | Controls whether a pen pressure changes the stroke and works around inaccurate pressure readings from some pens. |
