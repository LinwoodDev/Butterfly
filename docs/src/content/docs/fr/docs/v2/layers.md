...
Ici vous pouvez voir toutes les couches du projet. To create a new layer, use the Create button. To
...
|                 Option | Libellé                                                                           |
| ---------------------: | --------------------------------------------------------------------------------- |
|                Avancer | Renders the selection on top of the first element in front of it. |
| Envoyer vers l'arrière | Renders the selection under the first element behind it.          |
| Amener au premier plan | Renders the selection in front of everything else.                |
|    Envoyer à l'arrière | Renders the selection behind everything else.                     |
