...
A pack is a collection of components that can be used in the stamp tool. Vous pouvez créer votre propre pack ou importer un pack existant. To do this, click the top-left corner and select "Packs".
