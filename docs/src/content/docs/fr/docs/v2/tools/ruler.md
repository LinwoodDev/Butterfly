...
| ------------ | ---------- | ------------------------------------------------------------------------- |
| Taille       | 100        | The ruler's height.                                       |
| Arrière-plan | Non défini | Fill color of the ruler; uses the theme when unset.       |
| Premier plan | Non défini | Color of the ruler marks; chosen for contrast when unset. |
| Angle        | 0°         | Runtime angle control shown while the ruler is active.    |
