...
Click on [this link](https://play.google.com/apps/testing/dev.linwood.butterfly) to register for the [nightly](/nightly) version of the app. يرجى ملاحظة أن هذا الإصدار يمكن أن يحتوي على أخطاء. سيتم تحديث إصدار متجر التشغيل تلقائياً عند إصدار إصدار ليلي جديد.
