...
هنا يمكنك رؤية جميع الطبقات في المشروع. To create a new layer, use the Create button. To
...
|            خيار | الوصف                                                                             |
| --------------: | --------------------------------------------------------------------------------- |
| خطوة إلى الأمام | Renders the selection on top of the first element in front of it. |
|  خطوة إلى الخلف | Renders the selection under the first element behind it.          |
|      إلى الأمام | Renders the selection in front of everything else.                |
|       إلى الخلف | Renders the selection behind everything else.                     |
