...
A pack is a collection of components that can be used in the stamp tool. يمكنك إنشاء حزمة خاصة بك أو استيراد حزمة موجودة. To do this, click the top-left corner and select "Packs".
