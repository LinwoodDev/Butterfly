...
| --------: | :-------: | :-------------------------------------------------------------- |
|     اللون |    أسود   | The color of the property                                       |
|  الشفافية |  255 / 0  | The opacity of the color                                        |
|     تمويه |     0     | How much the color transition to the background will be blurred |
...
|  الممتلكات |       الافتراضي      | الوصف                                                                         |
| ---------: | :------------------: | :---------------------------------------------------------------------------- |
|      تلوين |         White        | The color filter.                                             |
|   الشفافية |        255 / 0       | The opacity of the color. How transparent the image should be |
|      تمويه |           0          | How much the color transition to the background will be blurred               |
| حجم الصورة | 0.25 | How big the image should be                                                   |
...
|    الممتلكات |                    الافتراضي                    | الوصف                                                                                                                                              |
| -----------: | :---------------------------------------------: | :------------------------------------------------------------------------------------------------------------------------------------------------- |
|         ابدأ |             (0,0)            | Starting position of the linear-gradient axis; percentually relative to the top left corner                                                        |
|        نهاية |             (1,0)            | End position of the linear-gradient axis; percentually relative to the top left corner                                                             |
| نقاط الألوان | 2 Color stops (Black, White) | The offset of a Color stop percentually defines where along the gradient axis a color is placed. There are color and alpha options |

### Radial Gradient

|        الممتلكات |                           الافتراضي                          | الوصف                                                                                                                                                                        |
| ---------------: | :----------------------------------------------------------: | :--------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
|            الوسط | (0.5,0.5) | Position of the boundary circle's geometric middle at 100% offset, relative to the element bounds.                                                           |
...
| نصف القطر البؤري |                               0                              | Radius of the inner circle where the offset is 0%, relative to half the element bounding box's diagonal. Beyond it, the offset increases.    |
|     نقاط الألوان |        2 Color stops (Black, White)       | The offset of a Color stop percentually defines where between focal point and the boundary the color is placed. There are color and alpha options            |
