...
المناطق هي طريقة للحد من حجم الكانفاس. You can create areas by using the [area tool](tools/area). إذا قمت بالنقر على الخلفية يمكنك فتح مربع حوار قائمة المنطقة باستخدام قائمة السياق.
