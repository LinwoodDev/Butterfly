...
| -----------------------: | :-------: | :----------------------------------------------------------------------------------- |
| إخفاء المؤشر أثناء الرسم |    true   | يخفي مؤشر الفأرة أثناء الرسم، لذلك فإنه لا يغطي جرة القلم الخاصة بك. |
...
|       الممتلكات | الافتراضي | الوصف                                                                                                       |
| --------------: | :-------: | :---------------------------------------------------------------------------------------------------------- |
| إيماءات الإدخال |    true   | Lets you move and zoom the canvas with touch gestures, even while drawing tool is selected. |
|  إيماءة التحريك |    true   | يتيح إيماءات اللمس المتعددة تحريك الكانفا بدلاً من التفاعل مع محتوى الملاحظة.               |
...
| --------------------------: | :------------------------------: | :------------------------------------------------------------------------------------------------------------------------------- |
|    الرسم باستخدام القلم فقط | Automatic, Always on, Always off | Prevents accidental marks from your hand or mouse when only pen input can draw.                                  |
| إظهار زر الإدخال بالقلم فقط |            true, false           | يعرض تبديل سريع للقلم فقط في المحرر بعد اكتشاف الفراشة لقلم.                                                     |
|                 تجاهل الضغط |       Never, First, Always       | Controls whether a pen pressure changes the stroke and works around inaccurate pressure readings from some pens. |
