...
|      دمج المسارات |                                  خاطئ                                  | This will merge all strokes it touches into one path                                                                                    |
|      اكتشاف الشكل | false (Delay: 0.5s) | This will try to detect shapes while drawing. If a shape is detected, it will be replaced by the shape. |
