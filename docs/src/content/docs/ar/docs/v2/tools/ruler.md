...
| --------- | --------- | ------------------------------------------------------------------------- |
| الحجم     | 100       | The ruler's height.                                       |
| الخلفية   | غير محدد  | Fill color of the ruler; uses the theme when unset.       |
| الأمامي   | غير محدد  | Color of the ruler marks; chosen for contrast when unset. |
| الزاوية   | 0°        | Runtime angle control shown while the ruler is active.    |
