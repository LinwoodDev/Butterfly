...
| ------- | ---------------------------------------- | ------------------------------------------------------------------------------------------------------- |
| Barva   | Black for strokes; transparent for fills | Color of the painted region.                                                            |
...
| Majetek          | Výchozí                                                               | Popis                                                                                                                           |
| ---------------- | --------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------- |
| Barevné zastávky | Black at `0`; white at `1`                                            | Each stop has an offset, color, and alpha value. The offset determines where the color appears. |
...
| Majetek | Výchozí  | Popis                                       |
| ------- | -------- | ------------------------------------------- |
| Začít   | `(0, 0)` | Start of the gradient axis. |
| Ukončit | `(1, 0)` | End of the gradient axis.   |
...
| Majetek      | Výchozí              | Popis                                                                         |
| ------------ | -------------------- | ----------------------------------------------------------------------------- |
| Uprostřed    | `(0.5, 0.5)`         | Center of the outer circle, relative to the element bounds.   |
| Radius       | `0.5`                | Radius of the outer circle.                                   |
| Fokální bod  | Off; uses the center | Enable to move the inner starting point away from the center. |
...
| Majetek | Výchozí | Popis                                                                                          |
| ------- | ------- | ---------------------------------------------------------------------------------------------- |
| Zdroj   | Nic     | Image or SVG to use in the painted region.                                     |
...
| Měřítko | `0.25`  | Size of the source pattern in the painted region.                              |
| Blur    | `0`     | Softens the painted edge.                                                      |
