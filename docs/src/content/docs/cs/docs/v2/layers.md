...
Zde můžete vidět všechny vrstvy v projektu. To create a new layer, use the Create button. To
...
|            Možnost | Popis                                                                             |
| -----------------: | --------------------------------------------------------------------------------- |
|     Posunout vpřed | Renders the selection on top of the first element in front of it. |
|        Poslat zpět | Renders the selection under the first element behind it.          |
| Přivést do popředí | Renders the selection in front of everything else.                |
|        Poslat zpět | Renders the selection behind everything else.                     |
