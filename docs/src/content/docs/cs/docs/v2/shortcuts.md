...
| ------------------------: | :-----: | :------------------------------------------------------------------------- |
| Skrýt kurzor při kreslení |   true  | Při kreslení skryje kurzor myši, takže nepokrývá tvůj tah. |
...
|          Majetek | Výchozí | Popis                                                                                                       |
| ---------------: | :-----: | :---------------------------------------------------------------------------------------------------------- |
|            Gesta |   true  | Lets you move and zoom the canvas with touch gestures, even while drawing tool is selected. |
| Přesunout gestem |   true  | Umožňuje vícenásobné dotykové gesta přesunout plátno místo interakce s obsahem poznámek.    |
...
|                      Majetek |              Values              | Popis                                                                                                                            |
| ---------------------------: | :------------------------------: | :------------------------------------------------------------------------------------------------------------------------------- |
|         Používat pouze tužku | Automatic, Always on, Always off | Prevents accidental marks from your hand or mouse when only pen input can draw.                                  |
| Zobrazit pouze přepínač pera |            true, false           | Zobrazí rychlý přepnutí v editoru poté, co Butterfly detekuje per.                                               |
|        Ignorovat sílu stisku |       Never, First, Always       | Controls whether a pen pressure changes the stroke and works around inaccurate pressure readings from some pens. |
