...
| ------------------ | --------------------- | ----------------------------------------------------------------------------------------------------------------------------------- |
| Řádky              | 3                     | Initial number of rows.                                                                                             |
| Sloupce            | 3                     | Initial number of columns.                                                                                          |
| Šířka              | 0                     | Fixed table width; `0` uses the default width based on the columns.                                                 |
| Výška              | 0                     | Fixed table height; `0` uses the default height based on the rows.                                                  |
...
| Vyplnit            | Průhledný             | Table background color and alpha.                                                                                   |
| Přiblížení závislé | Vypnuto               | Changes table creation size based on the zoom level.                                                                |
