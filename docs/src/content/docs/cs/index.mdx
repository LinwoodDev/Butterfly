...
<CardGrid stagger>
  <Card title="Křížová platforma" icon="laptop">
  ...
  <Card title="Vyberte, kde jsou vaše data uložena" icon="open-book">
...
<LinkCard title="Download today" href="/stahování/" />
