...
Visita [las descargas](/downloads) para descargar la aplicación para tu plataforma. Usa la versión [web](https://v1.butterfly.linwood.dev) si no encuentras tu plataforma.
