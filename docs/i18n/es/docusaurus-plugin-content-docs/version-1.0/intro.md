...
Visita [las descargas](/downloads) para descargar la aplicación para tu plataforma. Use [web version](https://v1.web.butterfly.linwood.dev) if you cannot find your platform.
...
- Las opciones de edición de la barra de herramientas son los pintores. Puedes encontrar [aquí](background/intro) más.
