...
## Бета-программа для Play Маркет

Нажмите на [эту ссылку](https://play.google.com/apps/testing/dev.linwood.butterfly) , чтобы зарегистрироваться на [ночную](/nightly) версию приложения. Пожалуйста, обратите внимание, что эта версия может содержать ошибки. Версия плей-магазина будет автоматически обновляться при выпуске новой ночной версии.
