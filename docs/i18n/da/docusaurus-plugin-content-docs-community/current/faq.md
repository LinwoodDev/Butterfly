...
Butterfly er tilgængelig på iOS som forhåndsvisning. Klik på [her](https://butterfly.linwood.dev/downloads/ios) for at downloade den. Se [her](https://github.com/LinwoodDev/Butterfly/issues/244#issuecomment-1935460878) hvorfor det ikke er tilgængeligt i App Store.
