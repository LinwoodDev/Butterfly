...
## beta programmet på play butik

Klik på [dette link](https://play.google.com/apps/testing/dev.linwood.butterfly) for at registrere dig til [natlig](/nightly) versionen af appen. Bemærk, at denne version kan have fejl. Afspilningsbutikkens version opdateres automatisk, når en ny natlig version frigives.
