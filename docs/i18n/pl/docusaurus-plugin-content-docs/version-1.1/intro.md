...
Odwiedź [pobieranych](/downloads) aby pobrać aplikację na swoją platformę. Użyj [web version](https://web.butterfly.linwood.dev) jeśli nie możesz znaleźć swojej platformy.
