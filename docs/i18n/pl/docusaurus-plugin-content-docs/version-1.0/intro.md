...
Odwiedź [pobieranych](/downloads) aby pobrać aplikację na swoją platformę. Użyj [web version](https://v1.butterfly.linwood.dev) jeśli nie możesz znaleźć swojej platformy.
