...
Please use the flatpak version if possible. Please use the flatpak version if possible. Please use the flatpak version if possible. Please use the flatpak version if possible. Please use the flatpak version if possible. Otherwise you need to install `libsecret-1-dev` and `libjsoncpp-dev`.
